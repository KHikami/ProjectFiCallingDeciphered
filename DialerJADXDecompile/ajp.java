...
public final class ajp implements ajt, Callback {
    ...
    static Notification a(Context context, String str, String str2, Intent intent) {
        return a(context, str, str2, intent, 0);
    }
    ...
    public final void a(ajh ajh, int i, int i2) {
        ...
        this.a.notify("VCardServiceProgress", i, a(this.b, 1, string, string, i, str, -1, 0));
    }
    ...
    public final void a(ajh ajh, int i, bfs bfs, int i2, int i3) {
        if (!bfs.b()) {
            ...
            this.a.notify("VCardServiceProgress", i, a(this.b.getApplicationContext(), 1, this.b.getString(buf.ft, new Object[]{bfs.c()}), string, i, ajh.d, i3, i2));
        }
    }
    ...
    public final void a(ajh ajh, int i) {
        this.a.notify("VCardServiceProgress", i, a(this.b, this.b.getString(buf.fs, new Object[]{ajh.d})));
    }
