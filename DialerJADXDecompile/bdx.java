...
public final class bdx implements bcv, bcx {
    ...
    public final void a(bcu bcu, bcu bcu2, azs azs) {
        ...
        if (c(this.b) && h && this.c) {
            b();
        } else if (!b(this.b) && h && this.c) {
            b();
        }
        c(j);
    }
    ...
    private final void b(ayo ayo) {
        ...
        if ((z || c(this.b) || (ayo != null && VideoProfile.isPaused(ayo.k()))) && h && !this.c) {
            a(ayo, true);
        } else if (a(ayo) && a(this.b)) {
            a(this.b.c, false);
        }
        c(ayo);
    }
