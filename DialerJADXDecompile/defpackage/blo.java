...
public class blo {
    ...
    private static byte[] c(Context context, String str, String str2, List list) {
        ...
        try {
            ...
            try {
                Object obj;
                blo.a(httpURLConnection2, str2, list);
    ...
    private static URL b(Context context, String str) {
        ...
        if (a != null) {
            ...
            if (bdf.a) {
                str2 = a;
                str3 = "fetching ";
                valueOf = String.valueOf(blo.a(a));
                bdf.a(str2, valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3));
                if (!a.equals(str)) {
                    valueOf = a;
                    str2 = String.valueOf(blo.a(str));
                    str3 = String.valueOf(blo.a(a));
