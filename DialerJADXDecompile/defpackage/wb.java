...
/* compiled from: PG */
/* renamed from: wb */
final class wb implements ListAdapter, SpinnerAdapter {
    private SpinnerAdapter a;
    private ListAdapter b;

    public wb(SpinnerAdapter spinnerAdapter, Theme theme) {
        this.a = spinnerAdapter;
        if (spinnerAdapter instanceof ListAdapter) {
            this.b = (ListAdapter) spinnerAdapter;
        }
        if (theme != null && vz.a && (spinnerAdapter instanceof ThemedSpinnerAdapter)) {
