        ...
        try {
            for (Entry entry : bos.a.entrySet()) {
                ...
                if (!("ht".equals(str) || "qt".equals(str) || "AppUID".equals(str) || "z".equals(str) || "_gmsv".equals(str))) {
                    bov.a(stringBuilder, str, (String) entry.getValue());
                }
            }
            bov.a(stringBuilder, "ht", String.valueOf(bos.d));
            bov.a(stringBuilder, "qt", String.valueOf(f().a() - bos.d));
            if (btq.a) {
                bov.a(stringBuilder, "_gmsv", bpc.a);
            }
            if (z) {
                String valueOf;
