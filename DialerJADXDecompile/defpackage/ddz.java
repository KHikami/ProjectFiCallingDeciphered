...
final class ddz extends dec {
    ...
    public final int a(int i) {
        return ddz.a(this.e, this.c, i);
    }

    public final String b(int i) {
        return this.g[ddz.a(this.f, this.d, i)];
    }
    ...
    public final void a(ObjectInput objectInput) {
        ...
        while (i2 < this.a) {
            ddz.a(objectInput, this.c, this.e, i2);
            ddz.a(objectInput, this.d, this.f, i2);
            i2++;
        }
    }
    ...
    public final void a(ObjectOutput objectOutput) {
        ...
        for (i = 0; i < this.a; i++) {
            ddz.a(objectOutput, this.c, this.e, i);
            ddz.a(objectOutput, this.d, this.f, i);
        }
    }
