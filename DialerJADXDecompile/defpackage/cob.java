...
public class cob {
    ...
    public static void a(LayoutInflater layoutInflater, jl jlVar) {
        ...
        if (factory instanceof Factory2) {
            cob.a(layoutInflater, (Factory2) factory);
        } else {
            cob.a(layoutInflater, jkVar);
        }
    }
    ...
    public static void a(boolean z, String str, char c) {
        if (!z) {
            throw new IllegalArgumentException(cob.a(str, Character.valueOf(c)));
        }
    }

    public static void a(boolean z, String str, int i) {
        if (!z) {
            throw new IllegalArgumentException(cob.a(str, Integer.valueOf(i)));
        }
    }

    public static void a(boolean z, String str, long j) {
        if (!z) {
            throw new IllegalArgumentException(cob.a(str, Long.valueOf(j)));
        }
    }

    public static void a(boolean z, String str, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(cob.a(str, obj));
        }
    }

    public static void a(boolean z, String str, char c, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(cob.a(str, Character.valueOf(c), obj));
        }
    }

    public static void a(boolean z, String str, Object obj, Object obj2) {
        if (!z) {
            throw new IllegalArgumentException(cob.a(str, obj, obj2));
        }
    }
    ...
    public static void b(boolean z, String str, Object obj) {
        if (!z) {
            throw new IllegalStateException(cob.a(str, obj));
        }
    }
    ...
    public static Object a(Object obj, String str, Object obj2) {
        ...
        throw new NullPointerException(cob.a(str, obj2));
    }

    public static int b(int i, int i2) {
        return cob.a(i, i2, "index");
    }
    ...
    public static int a(int i, int i2, String str) {
        ...
        throw new IndexOutOfBoundsException(cob.b(i, i2, str));
    }

    public static String b(int i, int i2, String str) {
        if (i < 0) {
            return cob.a("%s (%s) must not be negative", str, Integer.valueOf(i));
        } else if (i2 < 0) {
            throw new IllegalArgumentException("negative size: " + i2);
        } else {
            return cob.a("%s (%s) must be less than size (%s)", str, Integer.valueOf(i), Integer.valueOf(i2));
        }
    }

    public static int c(int i, int i2) {
        return cob.c(i, i2, "index");
    }
    ...
    public static int c(int i, int i2, String str) {
        ...
        throw new IndexOutOfBoundsException(cob.d(i, i2, str));
    }
    ...
    public static String d(int i, int i2, String str) {
        if (i < 0) {
            ...
            return cob.a("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i), Integer.valueOf(i2));
        }
    }

    public static void b(int i, int i2, int i3) {
        if (i < 0 || i2 < i || i2 > i3) {
            throw new IndexOutOfBoundsException(cob.c(i, i2, i3));
        }
    }

    public static String c(int i, int i2, int i3) {
        if (i < 0 || i > i3) {
            return cob.d(i, i3, "start index");
        }
        if (i2 < 0 || i2 > i3) {
            return cob.d(i2, i3, "end index");
        }
        return cob.a("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
    }
