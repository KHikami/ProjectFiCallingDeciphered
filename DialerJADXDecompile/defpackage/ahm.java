...
public final class ahm {
    ...
    public final String toString() {
        ...
        stringBuilder.append(" typeList=").append(ahm.a(this.k));
        stringBuilder.append(" fieldList=").append(ahm.a(this.l));
        stringBuilder.append(" defaultValues=").append(this.m);
        stringBuilder.append(" dateFormatWithoutYear=").append(ahm.a(this.n));
        stringBuilder.append(" dateFormatWithYear=").append(ahm.a(this.o));
