...
public class bim implements bea {
    ...
    public final boolean a(String str, beb beb) {
        ...
        try {
            ...
            new bin(this, a(Calendar.getInstance().get(7), optJSONObject.getJSONObject("placeDetails")), beb).execute(new Address[]{bim.a(r3.optString("data1", null), optJSONObject)});
            return true;
    ...
    private List a(int i, JSONObject jSONObject) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                ...
                int i3 = i - 1;
                int a = bim.a(jSONObject3.getInt("day") - i3);
                if (a == 0) {
                    obj2 = 1;
                } else {
                    obj2 = null;
                ...
                if (obj2 != null || (r3 != null && obj == null)) {
                    Calendar a2 = a(jSONObject3.getString("time"), bim.a(a));
                    Calendar a3 = a(jSONObject4.getString("time"), bim.a(jSONObject4.getInt("day") - i3));
                    if (!(a2 == null || a3 == null)) {
                        if (obj2 != null) {
