...
public class buf {
    ...
    public static bl[] a(String str) {
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                buf.a(arrayList, trim.charAt(0), buf.b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            buf.a(arrayList, str.charAt(i2), new float[0]);
        }
    ...
    public static void a(java.lang.String r7, int r8, defpackage.bk r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.b = r1;
    ...
    public static int b(TypedArray typedArray, XmlPullParser xmlPullParser, String str, int i, int i2) {
        return !buf.a(xmlPullParser, str) ? i2 : typedArray.getColor(i, i2);
    }
    ...
    public static Object a(Object obj, View view, ArrayList arrayList, Map map, View view2) {
        ...
        arrayList.add(view2);
        buf.b((Transition) obj, arrayList);
        return obj;
    }
    ...
    public static void a(Object obj, View view) {
        ((Transition) obj).setEpicenterCallback(new dz(buf.e(view)));
    }
    ...
    public static void a(Object obj, Object obj2, Object obj3, ArrayList arrayList, boolean z) {
        ...
        buf.a((Transition) obj, transition2, arrayList, z);
        buf.a(transition, transition2, arrayList, z);
    }
    ...
    public static void a(Object obj, Object obj2, Object obj3, View view, ee eeVar, View view2, ed edVar, Map map, ArrayList arrayList, ArrayList arrayList2, Map map2, Map map3, ArrayList arrayList3) {
        ...
        buf.a(transition, transition2, arrayList2, true);
        if (obj != null || obj2 != null) {
            if (transition != null) {
                transition.addTarget(view2);
            }
            if (obj2 != null) {
                buf.a((Object) transition3, view2, map2, arrayList3);
                buf.a(transition, transition3, arrayList3, true);
                buf.a(transition2, transition3, arrayList3, true);
            }
            view.getViewTreeObserver().addOnPreDrawListener(new ea(view, transition, view2, eeVar, map, map3, arrayList, transition2));
            buf.a(transition, edVar);
        }
    }
    ...
    public static void a(Object obj, View view, Map map, ArrayList arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            buf.a(targets, (View) arrayList.get(i));
        }
        arrayList.add(view);
        buf.b(obj, arrayList);
    }
    ...
    public static void a(ArrayList arrayList, View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            for (int i = 0; i < childCount; i++) {
                buf.a(arrayList, viewGroup.getChildAt(i));
            }
            return;
        }
        arrayList.add(view);
    ...
    public static void a(Map map, View view) {
        if (view.getVisibility() == 0) {
            ...
            if (view instanceof ViewGroup) {
                ...
                int childCount = viewGroup.getChildCount();
                for (int i = 0; i < childCount; i++) {
                    buf.a(map, viewGroup.getChildAt(i));
                }
            }
        }
    }
    ...
    public static void a(Object obj, ArrayList arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            for (int i = 0; i < transitionCount; i++) {
                buf.a(transitionSet.getTransitionAt(i), arrayList);
            }
        } else if (!buf.a(transition)) {
    ...
    public static void b(Object obj, ArrayList arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            while (i < transitionCount) {
                buf.b(transitionSet.getTransitionAt(i), arrayList);
                i++;
            }
        } else if (!buf.a(transition) && buf.a(transition.getTargets())) {
            int size = arrayList.size();
    ...
    public static boolean a(Transition transition) {
        return (buf.a(transition.getTargetIds()) && buf.a(transition.getTargetNames()) && buf.a(transition.getTargetTypes())) ? false : true;
    }
    ...
    public static int a(Context context, String str) {
        return buf.a(context, str, Process.myPid(), Process.myUid(), context.getPackageName());
    }
    ...
    public static int c(Resources resources) {
        return Math.min(buf.b(resources), buf.a(resources));
    }
    ...
    public static Object a(Object obj, oj ojVar, oi oiVar, Object obj2, int i, boolean z, boolean z2) {
        ...
        switch (i) {
            case rq.b /*1*/:
                return buf.b(obj2, arrayList, false);
            case rq.c /*2*/:
                return buf.a(obj2, arrayList, false);
            default:
    ...
    public static boolean a(int i, Rect rect, Rect rect2, Rect rect3) {
        if (!buf.a(rect, rect2, i)) {
            return false;
        }
        if (!buf.a(rect, rect3, i)) {
            return true;
        }
        if (buf.b(i, rect, rect2, rect3)) {
            return true;
        }
        if (buf.b(i, rect, rect3, rect2) || buf.c(buf.c(i, rect, rect2), buf.g(i, rect, rect2)) >= buf.c(buf.c(i, rect, rect3), buf.g(i, rect, rect3))) {
            return false;
        }
        return true;
    }
    ...
    public static boolean b(int i, Rect rect, Rect rect2, Rect rect3) {
        boolean a = buf.a(i, rect, rect2);
        if (buf.a(i, rect, rect3) || !a) {
            return false;
        }
        if (!buf.b(i, rect, rect3) || i == 17 || i == 66 || buf.c(i, rect, rect2) < buf.e(i, rect, rect3)) {
            return true;
        }
        return false;
    }
    ...
    public static int c(int i, Rect rect, Rect rect2) {
        return Math.max(0, buf.d(i, rect, rect2));
    }
    ...
    public static int e(int i, Rect rect, Rect rect2) {
        return Math.max(1, buf.f(i, rect, rect2));
    }
    ...
    public static ColorStateList a(Resources resources, XmlPullParser xmlPullParser, Theme theme) {
        ...
        if (next == 2) {
            return buf.a(resources, xmlPullParser, asAttributeSet, theme);
        }
    ...
    public static ColorStateList a(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        ...
        if (name.equals("selector")) {
            return buf.b(resources, xmlPullParser, attributeSet, theme);
        }
    ...
    public static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        ...
        while (true) {
            ...
            if (depth2 < depth && next == 3) {
                ...
                int i2;
                TypedArray a = buf.a(resources, theme, attributeSet, rk.ak);
    ...
    public static int d(Context context) {
        if (!buf.c(context, "android.permission.READ_PHONE_STATE") || !abw.c()) {
            return 0;
        }
    ...
    public static boolean e(Context context) {
        return (buf.d(context) & 1) != 0;
    }

    public static boolean f(Context context) {
        if (!buf.c(context, "android.permission.READ_PHONE_STATE") || !abw.e()) {
            return false;
        }
        TelecomManager telecomManager = (TelecomManager) context.getSystemService("telecom");
        if (telecomManager == null) {
    ...
    public static String g(Context context) {
        ...
        if (TextUtils.isEmpty(networkCountryIso)) {
            if (Geocoder.isPresent() && buf.j(a.b)) {
    ...
    public static String b(Context context, String str) {
        try {
            return ddt.a().a(ddk.a().a(str, buf.g(context)), context.getResources().getConfiguration().locale);
        } catch (ddi e) {
            return null;
        }
    }
    ...
    public static boolean c(long j) {
        return buf.c() ? Directory.isEnterpriseDirectoryId(j) : false;
    }
    ...
    public static CharSequence b(CharSequence charSequence) {
        ...
        buf.a(newSpannable, 0, newSpannable.length());
        return newSpannable;
    }

    public static void a(Spannable spannable, int i, int i2) {
        spannable.setSpan(buf.g(spannable.subSequence(0, i2).toString()), 0, i2, 33);
    }
    ...
    public static TtsSpan h(String str) {
        ...
        if (ddo == null) {
            telephoneBuilder.setNumberParts(buf.c((CharSequence) str));
        } else {
            if (ddo.a) {
    ...
    public static void a(Resources resources, ListView listView, View view) {
        ...
        if (integer > 0 && integer2 > 0) {
            ...
            buf.a((View) listView, false, new ain(listView, view, integer, integer2));
        }
    }
    ...
    public static void b(Context context, Intent intent) {
        ...
        if (obj == null || buf.c(context, intent) == null) {
            context.startActivity(intent);
            return;
        }
    ...
    public static boolean h(Context context) {
        return buf.c(context, "android.permission.CALL_PHONE");
    }

    public static boolean i(Context context) {
        return buf.c(context, "android.permission.READ_CONTACTS");
    }

    public static boolean j(Context context) {
        return buf.c(context, "android.permission.ACCESS_FINE_LOCATION");
    }
    ...
    public static void a(Context context, TextView textView) {
        buf.a(context, textView, false);
    }

    public static void a(Context context, TextView textView, boolean z) {
        new ait(buf.g(context), textView, false).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, null);
    }
    ...
    public static boolean a(Context context, String str, EditText editText) {
        ...
        if (buf.g(context, stripSeparators) || buf.h(context, stripSeparators) || buf.f(context, stripSeparators) || buf.b(context, stripSeparators, editText) || buf.e(context, stripSeparators)) {
            return true;
        }
        return false;
    }
    ...
    public static String a(Context context, PhoneAccountHandle phoneAccountHandle) {
        PhoneAccount d = buf.d(context, phoneAccountHandle);
    ...
    public static CharSequence a(Context context, CharSequence charSequence, int i, CharSequence charSequence2, CharSequence charSequence3, boolean z) {
        CharSequence a = buf.a(context, charSequence, i, z);
    ...
    public static String r(Context context) {
        return buf.w(context) ? null : "type";
    }

    public static String s(Context context) {
        return buf.w(context) ? null : "source";
    }
    ...
    public static String u(Context context) {
        return buf.w(context) ? null : "country_iso";
    }
    ...
    public static Uri a(Context context, Integer num) {
        if (num == null) {
            return buf.y(context);
        }
        return ContentUris.withAppendedId(buf.y(context), (long) num.intValue());
    }

    public static Uri y(Context context) {
        return buf.w(context) ? BlockedNumbers.CONTENT_URI : awe.a;
    }
    ...
    public static ContentValues a(Context context, String str, String str2, String str3) {
        ...
        contentValues.put(buf.t(context), (String) Objects.requireNonNull(str));
        if (!buf.w(context)) {
            if (str2 == null) {
                str2 = PhoneNumberUtils.formatNumberToE164(str, str3);
            }
            contentValues.put(buf.v(context), str2);
            contentValues.put(buf.u(context), str3);
            contentValues.put(buf.r(context), Integer.valueOf(1));
            contentValues.put(buf.s(context), Integer.valueOf(1));
        }
        return contentValues;
    }

    public static boolean a(Context context, FragmentManager fragmentManager, auo auo) {
        if (!buf.b(context, true)) {
            return false;
        }
        buf.a("FilteredNumberCompat, maybeShowBlockNumberMigrationDialog - showing migration dialog", new Object[0]);
    ...
    public static boolean a(Context context, String str, String str2, long j) {
        if (TextUtils.isEmpty(PhoneNumberUtils.formatNumberToE164(str, str2)) || buf.C(context)) {
            return false;
        }
    ...
    public static boolean C(Context context) {
        ...
        if (valueOf.longValue() == 0 || System.currentTimeMillis() - valueOf.longValue() >= buf.F(context)) {
            return false;
        }
        return true;
    }
    ...
    public static void E(Context context) {
        if (!buf.w(context) && !PreferenceManager.getDefaultSharedPreferences(context).getBoolean("notified_call_blocking_disabled_by_emergency_call", false)) {
            new aup(context).a(new avc(context));
        }
    }

    public static boolean b(Context context, String str, String str2) {
        Object c = buf.c(context, str, str2);
        return (TextUtils.isEmpty(c) || PhoneNumberUtils.isEmergencyNumber(c)) ? false : true;
    }

    public static String c(Context context, String str, String str2) {
        return (buf.w(context) && TextUtils.isEmpty(str)) ? str2 : str;
    }
    ...
    public static void a(String str, Object... objArr) {
        buf.a(4, "Dialer", str, objArr);
    }

    public static void b(String str, Object... objArr) {
        buf.a(6, "Dialer", str, objArr);
    }

    public static void a(String str, Throwable th) {
        buf.a(6, "Dialer", str, new Object[0]);
        buf.a(6, "Dialer", Log.getStackTraceString(th), new Object[0]);
    }

    public static void c(String str, Object... objArr) {
        buf.a(2, "Dialer", str, objArr);
    }
    ...
    public static VideoProfile i(ayo ayo) {
        ...
        if (!VideoProfile.isAudioOnly(ayo.k())) {
            return new VideoProfile(buf.j(ayo.k()));
        }
    ...
    public static VideoProfile j(ayo ayo) {
        Objects.requireNonNull(ayo);
        return new VideoProfile(buf.i(ayo.k()));
    }
    ...
    public static boolean g(CharSequence charSequence) {
        ...
        for (int i = 0; i < length; i++) {
            if (!buf.c(charSequence.charAt(i))) {
                return false;
            }
        }
        return true;
    ...
    public static der a(bde bde) {
        der der = new der();
        der.a = buf.a(bde.b, bde.c);
        der.b = buf.a(bde.c, bde.d);
        der.c = buf.a(bde.d, bde.e);
        der.d = buf.a(bde.e, bde.f);
        if (bde.a) {
            der.e = buf.a(bde.f, bde.g);
            if (!bde.i) {
                der.f = buf.a(bde.g, bde.h);
            }
        } else {
            der.f = buf.a(bde.f, bde.h);
        }
        return der;
    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.cwn p() {
        /*
        r7 = 0;
        r1 = 0;
        r2 = defpackage.bjd.l;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void a(defpackage.cwn r7, java.lang.String r8) {
        /*
        r1 = defpackage.bjd.n;
        r2 = 0;
        r0 = defpackage.crm.b;
    ...
    L_0x009e:
        ...
        defpackage.buf.c(r1, r2);
        r1 = 50;
        defpackage.buf.g(r8, r1);
        r1 = 51;
        defpackage.buf.g(r8, r1);
        r0 = r0.edit();
        r1 = "spam_jobs_scheduled";
    ...
    public static void g(Context context, int i) {
        ...
        String valueOf = String.valueOf(buf.l(i));
    ...
    public static void h(Context context, int i) {
        buf.c("SpamJobScheduler, cancelling job with id=" + i, new Object[0]);
        JobScheduler T = buf.T(context);
        if (T != null) {
            T.cancel(i);
        }
    }
    ...
    public static void i(Context context, int i) {
        JobScheduler T = buf.T(context);
        if (T != null) {
            JobInfo j = buf.j(context, i);
            String valueOf;
            if (buf.a(j, T)) {
                valueOf = String.valueOf(buf.l(i));
                buf.c(new StringBuilder(String.valueOf(valueOf).length() + 51).append("SpamJobScheduler, job with id ").append(valueOf).append(" is already scheduled").toString(), new Object[0]);
                return;
            }
    ...
    public static JobInfo j(Context context, int i) {
        ...
        builder.setPersisted(true).setPeriodic(m).setExtras(buf.e(m));
        switch (i) {
            case 50:
    ...
    public static void o(int i) {
        Assert.assertTrue(i + " is not a valid spam job", buf.n(i));
    }
    ...
    public static Intent a(Account account, ArrayList arrayList, String[] strArr, boolean z, String str, String str2, String[] strArr2, Bundle bundle) {
        return buf.a(account, null, strArr, true, null, null, null, null, false);
    }
    ...
    public static Intent a(Account account, ArrayList arrayList, String[] strArr, boolean z, String str, String str2, String[] strArr2, Bundle bundle, boolean z2) {
        return buf.a(account, arrayList, strArr, z, str, str2, strArr2, bundle, false, 0, 0);
    }
    ...
    public static Intent a(Account account, ArrayList arrayList, String[] strArr, boolean z, String str, String str2, String[] strArr2, Bundle bundle, boolean z2, int i, int i2) {
        return buf.a(account, arrayList, strArr, z, str, str2, strArr2, bundle, z2, 0, 0, null, false);
    }
    ...
    public static Intent a(Account account, ArrayList arrayList, String[] strArr, boolean z, String str, String str2, String[] strArr2, Bundle bundle, boolean z2, int i, int i2, String str3, boolean z3) {
        ...
        buf.b(true, (Object) "We only support hostedDomain filter for account chip styled account picker");
    ...
    public static void b(Parcel parcel, int i) {
        parcel.setDataPosition(buf.a(parcel, i) + parcel.dataPosition());
    }

    public static void a(Parcel parcel, int i, int i2) {
        int a = buf.a(parcel, i);
        if (a != i2) {
    ...
    public static boolean d(Resources resources) {
        ...
        return (buf.s() && ((resources.getConfiguration().screenLayout & 15) > 3)) || buf.e(resources);
    }

    @TargetApi(13)
    public static boolean e(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return buf.t() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    @TargetApi(20)
    public static boolean V(Context context) {
        return buf.y() && context.getPackageManager().hasSystemFeature("android.hardware.type.watch");
    }
    ...
    public static String W(Context context) {
        return buf.m(context, Binder.getCallingPid());
    }
    ...
    public static String e(int i, int i2) {
        ...
        for (int i4 = 3; i4 < i3; i4++) {
            stringBuffer.append(buf.a(stackTrace, i4)).append(" ");
        }
    ...
    public static String a(Context context, String str, Map map) {
        return buf.a(context, str, map, null);
    }
    ...
    public static String a(cla cla) {
        ...
        StringBuffer stringBuffer = new StringBuffer();
        try {
            buf.a(null, (Object) cla, new StringBuffer(), stringBuffer);
            return stringBuffer.toString();
    ...
    public static void a(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) {
        ...
        if (obj instanceof cla) {
            ...
            if (str != null) {
                stringBuffer2.append(stringBuffer).append(buf.q(str)).append(" <\n");
                stringBuffer.append("  ");
            }
            ...
            for (Field field : cls.getFields()) {
                ...
                if (!("cachedSize".equals(name) || (modifiers & 1) != 1 || (modifiers & 8) == 8 || name.startsWith("_") || name.endsWith("_"))) {
                    ...
                    if (!type.isArray()) {
                        buf.a(name, obj2, stringBuffer, stringBuffer2);
                    } else if (type.getComponentType() == Byte.TYPE) {
                        buf.a(name, obj2, stringBuffer, stringBuffer2);
                    } else {
                        int length2 = obj2 == null ? 0 : Array.getLength(obj2);
                        for (modifiers = 0; modifiers < length2; modifiers++) {
                            buf.a(name, Array.get(obj2, modifiers), stringBuffer, stringBuffer2);
                        }
                    }
                }
            }
                ...
                if (name3.startsWith("set")) {
                    ...
                    try {
                        if (((Boolean) cls.getMethod("has" + substring, new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                            try {
                                buf.a(substring, cls.getMethod("get" + substring, new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
                            } catch (NoSuchMethodException e) {
                            }
                        }
        ...
        if (obj instanceof String) {
            stringBuffer2.append("\"").append(buf.r((String) obj)).append("\"");
        } else if (obj instanceof byte[]) {
            buf.a((byte[]) obj, stringBuffer2);
        } else {
    ...
    public static cxc a(i iVar, cxe cxe, cxf cxf, int i, long j) {
        cvu cvu = cvu.c;
        return buf.a(cvu.a(), iVar, cxe, cxf, 1000, 100);
    }
    ...
    public static int E(Object obj) {
        return buf.C(obj == null ? 0 : obj.hashCode());
    }
    ...
    public static ArrayList b(Object... objArr) {
        cob.i((Object) objArr);
        Object arrayList = new ArrayList(buf.D(objArr.length));
    ...
    public static int D(int i) {
        buf.a(i, "arraySize");
        return buf.f((5 + ((long) i)) + ((long) (i / 10)));
    }
    ...
    public static String a(dem dem) {
        ...
        StringBuffer stringBuffer = new StringBuffer();
        try {
            buf.b(null, (Object) dem, new StringBuffer(), stringBuffer);
            return stringBuffer.toString();
        } catch (IllegalAccessException e) {
    ...
    public static void b(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) {
        ...
        if (obj instanceof dem) {
            ...
            int length = stringBuffer.length();
            if (str != null) {
                stringBuffer2.append(stringBuffer).append(buf.t(str)).append(" <\n");
                stringBuffer.append("  ");
            }
            Class cls = obj.getClass();
            for (Field field : cls.getFields()) {
                ...
                if (!("cachedSize".equals(name) || (modifiers & 1) != 1 || (modifiers & 8) == 8 || name.startsWith("_") || name.endsWith("_"))) {
                    ...
                    Object obj2 = field.get(obj);
                    if (!type.isArray()) {
                        buf.b(name, obj2, stringBuffer, stringBuffer2);
                    } else if (type.getComponentType() == Byte.TYPE) {
                        buf.b(name, obj2, stringBuffer, stringBuffer2);
                    } else {
                        int length2 = obj2 == null ? 0 : Array.getLength(obj2);
                        for (modifiers = 0; modifiers < length2; modifiers++) {
                            buf.b(name, Array.get(obj2, modifiers), stringBuffer, stringBuffer2);
                        }
                    }
                }
            }
                    ...
                    try {
                        ...
                        if (((Boolean) cls.getMethod(name3.length() != 0 ? name.concat(name3) : new String(name), new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                            try {
                                name = "get";
                                name3 = String.valueOf(substring);
                                buf.b(substring, cls.getMethod(name3.length() != 0 ? name.concat(name3) : new String(name), new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
                            } catch (NoSuchMethodException e) {
                            }
                        }
                    } catch (NoSuchMethodException e2) {
        ...
        stringBuffer2.append(stringBuffer).append(buf.t(str)).append(": ");
        if (obj instanceof String) {
            stringBuffer2.append("\"").append(buf.u((String) obj)).append("\"");
        } else if (obj instanceof byte[]) {
            buf.b((byte[]) obj, stringBuffer2);
        } else {
            stringBuffer2.append(obj);
        }
        stringBuffer2.append("\n");
