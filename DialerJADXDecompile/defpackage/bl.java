...
public final class bl {
    ...
    public bl(bl blVar) {
        this.a = blVar.a;
        this.b = buf.a(blVar.b, 0, blVar.b.length);
    }
    ...
    static void a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        d6 *= (double) f5;
        d = ((double) f6) * d5;
        bl.a(path2, (d6 * cos) - (d * sin), (d6 * sin) + (cos * d), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d3);
    }
