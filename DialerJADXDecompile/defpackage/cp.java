...
final class cp extends dy implements Runnable {
            ...
            for (cs csVar = this.a; csVar != null; csVar = csVar.a) {
                switch (csVar.c) {
                    ...
                    case rq.c /*2*/:
                            ...
                            for (int i = 0; i < this.s.c.size(); i++) {
                                ...
                                if (dbVar2 == null || dbVar3.z == dbVar2.z) {
                                    if (dbVar3 == dbVar2) {
                                        ...
                                        cp.a(sparseArray, sparseArray2, dbVar3);
                                    }
                                }
                            }
                        }
                        ...
                        break;
                    case rl.e /*3*/:
                        cp.a(sparseArray, sparseArray2, csVar.d);
                        break;
                    case rl.f /*4*/:
                        cp.a(sparseArray, sparseArray2, csVar.d);
                        break;
            ...
            if (ctVar == null) {
                ...
                if (arrayList != null) {
                    for (i = 0; i < arrayList.size(); i++) {
                        cp.a(ctVar.a, (String) arrayList.get(i), (String) arrayList2.get(i));
                    }
                }
            }
        }
    ...
    private final ct a(SparseArray sparseArray, SparseArray sparseArray2, boolean z) {
        ...
        while (i3 < sparseArray.size()) {
            if (a(sparseArray.keyAt(i3), ctVar, z, sparseArray, sparseArray2)) {
                i = 1;
            } else {
                i = i4;
            }
        ...
        while (i2 < sparseArray2.size()) {
            ...
            if (sparseArray.get(i) == null && a(i, ctVar, z, sparseArray, sparseArray2)) {
                i4 = 1;
            }
            i2++;
        }
    ...
    private final hv a(ct ctVar, db dbVar, boolean z) {
        ...
        if (this.p != null) {
            ...
            if (z) {
                ...
                hvVar = cp.a(this.p, this.q, hvVar);
            }
        }
        fx fxVar;
        if (z) {
