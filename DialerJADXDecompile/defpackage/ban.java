...
public class ban {
    ...
    public static bad a(Context context, ayo ayo) {
        ...
        if (!TextUtils.isEmpty(c)) {
            ...
            if (str != null) {
                String valueOf;
                String valueOf2 = String.valueOf(ban.a(str));
                ...
                if (bad.h == 1 || (bad.h != i3 && i3 == 1)) {
                    ...
                    valueOf = String.valueOf(ban.a(str));
                ...
                String valueOf4 = String.valueOf(ban.a(str));
        ...
        if ((ayo.b() != null && "voicemail".equals(ayo.b().getScheme())) || ban.b(context, ayo)) {
            bad.a(context);
        }
        bbc a = bbc.a(context);
