...
public final class adr extends ViewGroup implements SelectionBoundsAdjuster {
    ...
    protected final void onMeasure(int i, int i2) {
        ...
        int i5;
        View view = null;
        int resolveSize = adr.resolveSize(0, i);
        int i6 = this.y;
        this.aa = 0;
        this.ac = 0;
        this.ad = 0;
