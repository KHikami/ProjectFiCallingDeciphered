...
public final class art {
    ...
    final android.net.Uri a(android.net.Uri r10) {
        ...
        r0 = defpackage.art.a(r2);	 Catch:{ Throwable -> 0x0057, all -> 0x006d }
        if (r0 == 0) goto L_0x0051;
    L_0x003d:
        r0 = "_id";
        r0 = r2.getColumnIndex(r0);	 Catch:{ Throwable -> 0x0057, all -> 0x006d }
        r0 = r2.getInt(r0);	 Catch:{ Throwable -> 0x0057, all -> 0x006d }
        r4 = defpackage.awg.a(r0);	 Catch:{ Throwable -> 0x0057, all -> 0x006d }
    ...
    final android.content.ContentValues b(android.net.Uri r12) {
        ...
        r0 = defpackage.art.a(r2);	 Catch:{ Throwable -> 0x017c, all -> 0x01ab }
        if (r0 == 0) goto L_0x0171;
    L_0x0046:
        r0 = defpackage.art.a(r4);	 Catch:{ Throwable -> 0x017c, all -> 0x01ab }
        if (r0 == 0) goto L_0x0171;
    L_0x004c:
