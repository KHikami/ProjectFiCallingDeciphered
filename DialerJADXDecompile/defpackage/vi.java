...
public final class vi {
    ...
    L_0x0006:
        r8.p = r2;
        r0 = defpackage.buf.aB;
        r0 = r8.a(r9, r0, r1);
        if (r0 == 0) goto L_0x0027;
    L_0x0010:
        r3 = r0 instanceof defpackage.bn;
    ...
    final Drawable a(Context context, int i, boolean z, Drawable drawable) {
        ...
        if (b != null) {
            ...
            vi.a(r0.findDrawableByLayerId(16908288), aad.a(context, buf.L), a);
            vi.a(r0.findDrawableByLayerId(16908303), aad.a(context, buf.L), a);
            vi.a(r0.findDrawableByLayerId(16908301), aad.a(context, buf.J), a);
            return drawable;
        } else if (i == buf.aM || i == buf.aL || i == buf.aN) {
            r0 = (LayerDrawable) drawable;
            vi.a(r0.findDrawableByLayerId(16908288), aad.c(context, buf.L), a);
            vi.a(r0.findDrawableByLayerId(16908303), aad.a(context, buf.J), a);
            vi.a(r0.findDrawableByLayerId(16908301), aad.a(context, buf.J), a);
            return drawable;
        } else if (vi.a(context, i, drawable) || !z) {
            return drawable;
        } else {
            return null;
        }
    ...
    static boolean a(Context context, int i, Drawable drawable) {
        ...
        drawable.setColorFilter(vi.a(aad.a(context, i2), mode));
        if (i3 == -1) {
            return true;
        }
    ...
    public final ColorStateList b(Context context, int i) {
        ...
        ColorStateList a = i == buf.aA ? rm.a(context, buf.af) : i == buf.aU ? rm.a(context, buf.aj) : i == buf.aT ? rm.a(context, buf.ai) : i == buf.au ? vi.c(context, aad.a(context, buf.I)) : i == buf.ar ? vi.c(context, 0) : i == buf.at ? vi.c(context, aad.a(context, buf.H)) : (i == buf.aR || i == buf.aS) ? rm.a(context, buf.ah) : vi.a(e, i) ? aad.b(context, buf.L) : vi.a(h, i) ? rm.a(context, buf.ae) : vi.a(i, i) ? rm.a(context, buf.ad) : i == buf.aO ? rm.a(context, buf.ag) : colorStateList;
        if (a != null) {
            if (this.j == null) {
        ...
        if (!xi.b(drawable) || drawable.mutate() == drawable) {
            if (aaf.d || aaf.c) {
                ...
                if (!(colorStateList == null || mode == null)) {
                    colorFilter = vi.a(colorStateList.getColorForState(iArr, 0), mode);
                }
    ...
    private static void a(Drawable drawable, int i, Mode mode) {
        ...
        drawable.setColorFilter(vi.a(i, mode));
    }
}
