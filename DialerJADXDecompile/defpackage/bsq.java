...
public final class bsq extends brc implements bti {
    ...
    private final void a(int i) {
        if (this.x == null) {
            ...
            throw new IllegalStateException("Cannot use sign-in mode: " + bsq.b(i) + ". Mode was already set to " + bsq.b(this.x.intValue()));
        }
        if (this.i == null) {
            Object obj = null;
    ...
    public final ConnectionResult a(long j, TimeUnit timeUnit) {
        ...
        try {
            if (this.x == null) {
                this.x = Integer.valueOf(bsq.a(this.r.values(), false));
