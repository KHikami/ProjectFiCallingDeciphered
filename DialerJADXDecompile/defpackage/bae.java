...
public final class bae {
    ...
    public static void a(int i, Context context, bad bad, bal bal, Object obj) {
        ...
        if (buf.c(context, "android.permission.READ_CONTACTS")) {
            bae.a(-1, context, bad, new baf(context, bad, bal), obj, awt.a(bad.c));
            return;
        }
    ...
    static boolean b(int i, Context context, bad bad, bal bal, Object obj) {
        ...
        bae.a(context.getContentResolver().query(uri, b, null, null, null), arrayList);
        ...
        while (i2 < length) {
            long j = jArr[i2];
            Uri a = awt.a(bad.c, j);
            bae.a(i, context, bad, new bak(baj, j), obj, a);
            i2++;
        }
        return true;
    }
