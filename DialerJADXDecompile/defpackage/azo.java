...
public class azo extends bdj implements azz, bcr, bcs, bcv, bcx, bed {
    ...
    public final void a(bcu bcu, bcu bcu2, azs azs) {
        ...
        if (azq != null) {
            ...
            if (bcu2 == bcu.INCOMING) {
                ...
                ayo = ayo2;
                ayo2 = azo.a(azs, null, true);
            } else if (bcu2 == bcu.INCALL) {
                ayo = azo.a(azs, null, false);
                ayo2 = azo.a(azs, ayo, true);
            }
    ...
    L_0x00a1:
        r2 = defpackage.bcj.b();
        r2 = r2.n();
        r0 = defpackage.buf.a(r2, r0);
        if (r0 == 0) goto L_0x00f5;
    L_0x00af:
        r0 = r0.getSubscriptionAddress();
        r0 = defpackage.azo.a(r0);
    L_0x00b7:
        r2 = defpackage.bcj.b();
        r2 = r2.n();
        r3 = defpackage.bcj.b();
