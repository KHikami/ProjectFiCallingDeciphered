...
public abstract class btr {
    ...
    static {
        a = btr.b((CharSequence) "\t\n\u000b\f\r \u0085\u1680\u2028\u2029\u205f\u3000\u00a0\u180e\u202f").a(btr.a('\u2000', '\u200a'));
        btr.b((CharSequence) "\t\n\u000b\f\r \u0085\u1680\u2028\u2029\u205f\u3000").a(btr.a('\u2000', '\u2006')).a(btr.a('\u2008', '\u200a'));
        btr.a('\u0000', '\u007f');
        btr a = btr.a('0', '9');
        btr btr = a;
        for (char c : "\u0660\u06f0\u07c0\u0966\u09e6\u0a66\u0ae6\u0b66\u0be6\u0c66\u0ce6\u0d66\u0e50\u0ed0\u0f20\u1040\u1090\u17e0\u1810\u1946\u19d0\u1b50\u1bb0\u1c40\u1c50\ua620\ua8d0\ua900\uaa50\uff10".toCharArray()) {
            btr = btr.a(btr.a(c, (char) (c + 9)));
        }
        btr.a('\t', '\r').a(btr.a('\u001c', ' ')).a(btr.b('\u1680')).a(btr.b('\u180e')).a(btr.a('\u2000', '\u2006')).a(btr.a('\u2008', '\u200b')).a(btr.a('\u2028', '\u2029')).a(btr.b('\u205f')).a(btr.b('\u3000'));
        bts bts = new bts();
        bty bty = new bty();
        btz btz = new btz();
        bua bua = new bua();
        bub bub = new bub();
        btr.a('\u0000', '\u001f').a(btr.a('\u007f', '\u009f'));
        btr.a('\u0000', ' ').a(btr.a('\u007f', '\u00a0')).a(btr.b('\u00ad')).a(btr.a('\u0600', '\u0603')).a(btr.b((CharSequence) "\u06dd\u070f\u1680\u17b4\u17b5\u180e")).a(btr.a('\u2000', '\u200f')).a(btr.a('\u2028', '\u202f')).a(btr.a('\u205f', '\u2064')).a(btr.a('\u206a', '\u206f')).a(btr.b('\u3000')).a(btr.a('\ud800', '\uf8ff')).a(btr.b((CharSequence) "\ufeff\ufff9\ufffa\ufffb"));
        btr.a('\u0000', '\u04f9').a(btr.b('\u05be')).a(btr.a('\u05d0', '\u05ea')).a(btr.b('\u05f3')).a(btr.b('\u05f4')).a(btr.a('\u0600', '\u06ff')).a(btr.a('\u0750', '\u077f')).a(btr.a('\u0e00', '\u0e7f')).a(btr.a('\u1e00', '\u20af')).a(btr.a('\u2100', '\u213a')).a(btr.a('\ufb50', '\ufdff')).a(btr.a('\ufe70', '\ufeff')).a(btr.a('\uff61', '\uffdc'));
        buc buc = new buc();
        b = new btt();
    }
    ...
    private static btr b(CharSequence charSequence) {
        switch (charSequence.length()) {
            case rl.c /*0*/:
                return b;
            case rq.b /*1*/:
                return btr.b(charSequence.charAt(0));
            case rq.c /*2*/:
