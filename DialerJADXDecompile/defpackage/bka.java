...
public class bka extends PreferenceFragment implements OnPreferenceChangeListener, cc {
    ...
    public void onCreate(android.os.Bundle r11) {
        ...
        r0 = r10.getResources();
        r4 = defpackage.buf.lI;
        r0 = r0.getString(r4);
        r4 = r10.getResources();
        r5 = defpackage.buf.lL;
        r4 = r4.getString(r5);
        r5 = r10.getResources();
        r6 = defpackage.buf.lH;
        r5 = r5.getString(r6);
        r6 = r10.getResources();
        r7 = defpackage.buf.lJ;
        r6 = r6.getString(r7);
        r7 = r10.getResources();
        r8 = defpackage.buf.lK;
        r7 = r7.getString(r8);
        r8 = defpackage.buf.lT;
