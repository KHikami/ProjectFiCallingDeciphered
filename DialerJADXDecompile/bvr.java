...
public final class bvr {
    ...
    public final void a(Context context, String str, String str2, Intent intent, int i) {
        Object obj = !btq.a ? null : b() == bvv.b ? null : 1;
        if (obj != null && this.g != null) {
            ...
            if (i != 4 && i != 1) {
                ...
                W = buf.W(context);
                obj = (this.c.contains(W) || this.d.contains(str2) || this.e.contains(str3) || this.f.contains(str4) || (str3.equals(W) && (b() & bvv.d) != 0)) ? null : 1;
                if (obj != null) {
                    this.g.a(str);
                } else {
                    return;
