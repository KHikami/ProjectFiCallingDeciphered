...
final class bob extends bpb {
    ...
    public final long a(bns r11, boolean r12) {
        /*
        r10 = this;
        buf.A(r11);
        r10.o();
        ...
        buf.n(r1);	 Catch:{ SQLiteException -> 0x00af }
        r0.o();	 Catch:{ SQLiteException -> 0x00af }
        cqn.b();	 Catch:{ SQLiteException -> 0x00af }
    ...
    L_0x0041:
        ...
        buf.n(r1);	 Catch:{ SQLiteException -> 0x00af }
        buf.n(r4);	 Catch:{ SQLiteException -> 0x00af }
        r0.o();	 Catch:{ SQLiteException -> 0x00af }
        cqn.b();	 Catch:{ SQLiteException -> 0x00af }
