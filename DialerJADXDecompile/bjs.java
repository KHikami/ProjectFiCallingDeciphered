    ...
    public static bjt a(String str, String str2, String str3, String str4, int i) {
        ...
        try {
            ...
            if ("plus#peopleList".equals(string)) {
                JSONObject a = a(jSONObject, "items");
                if (a == null) {
                    return null;
                }
                String[] c;
                ...
                if (optJSONObject != null) {
                    ...
                    c = c(optJSONObject, "attributions");
                    obj = obj3;
                } else {
                    c = null;
                    int i2 = 1;
                ...
                jSONObject = a(a, "names");
                if (jSONObject != null) {
                    string = jSONObject.getString("displayName");
                    jSONObject2.put("vnd.android.cursor.item/name", a(jSONObject, b));
                }
                jSONObject = d(a, str2);
                if (jSONObject != null) {
                ...
                if (c == null) {
                    if (obj == null) {
                        ...
                        a(jSONObject2, a(a));
                        jSONObject2.putOpt("placeDetails", a(a, "placeDetails"));
                    }
                    str8 = ble.a(i, b(a, str4), false, false);
                }
