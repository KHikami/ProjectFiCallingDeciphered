...
final class bz implements Runnable {
    ...
    L_0x0026:
        r3 = move-exception;
        r4 = io.grpc.internal.bx.a;	 Catch:{ all -> 0x0050 }
    ...
    L_0x0069:
        ...
        goto L_0x0061;
        */
        throw new UnsupportedOperationException("Method not decompiled: io.grpc.internal.bz.run():void");
    }
}
