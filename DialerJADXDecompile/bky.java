...
public final class bky extends SQLiteOpenHelper {
    ...
    public final boolean a(dcy r13, long r14, java.lang.String[] r16) {
        /*
        r12 = this;
        r0 = 1;
        r1 = 0;
    ...
    L_0x001b:
        ...
        buf.a(r2, r4);	 Catch:{ all -> 0x00ad }
        r2 = r0;
    L_0x0024:
        if (r2 == 0) goto L_0x00ab;
    L_0x0026:
        r2 = a(r14, r16);	 Catch:{ all -> 0x00ad }
        if (r2 == 0) goto L_0x00ab;
    L_0x002c:
    ...
    public final boolean a(dcx dcx, long j, String[] strArr) {
        ...
        try {
            ...
            boolean z = a(writableDatabase, dcx.a) && a(j, strArr);
            if (z) {
