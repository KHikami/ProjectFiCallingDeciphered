...
public final class get {
    ...
    public static int m17420a(Context context) {
        ...
        if (telephonyManager.getPhoneType() == 2 && (a instanceof CellInfoCdma)) {
            ...
            i = 0;
            if (i == 0) {
                glk.m17979c("Babel_telephony", "TeleRoamingDetector.getRoamingStatus, not on Sprint Cdma, is roaming", new Object[0]);
                return 1;
            }
        }
        return 2;
