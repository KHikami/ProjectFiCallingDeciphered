...
public interface ebv {
    public static final String[] f11143a = new String[]{"author_first_name", "author_full_name", "author_chat_id", "text", "type", "local_url", "remote_url", "conversation_id", "conversation_name", "generated_name", "conversation_type", "timestamp", "status", "attachment_content_type", "transport_type", "author_gaia_id", "new_conversation_name", "participant_keys", "merge_key", "sms_type", "chat_watermark", "chat_ringtone_uri", "otr_status", "call_media_type", "author_profile_photo_url", "_id", "message_id", "is_user_mentioned"};
    public static final String f11144b;
    public static final String f11145c;
    public static final String f11146d;
    public static final String f11147e;
    public static final String f11148f;
    public static final String f11149g;
    public static final String f11150h;
    public static final String f11151i;
    public static final String f11152j;
    public static final String f11153k;
    ...
    static {
        ...
        f11144b = new StringBuilder((((((((String.valueOf(valueOf).length() + 68) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length()) + String.valueOf(valueOf4).length()) + String.valueOf(valueOf5).length()) + String.valueOf(valueOf6).length()) + String.valueOf(valueOf7).length()) + String.valueOf(valueOf8).length()).append(valueOf).append(ordinal).append(" AND ").append(valueOf2).append("!=").append(ordinal2).append(" AND ").append(valueOf3).append("!=1").append(" AND ").append(valueOf4).append(">").append(valueOf5).append(" AND ").append(valueOf6).append(" > ").append(valueOf7).append(" AND ").append(valueOf8).append(">?").toString();
        ...
        valueOf = String.valueOf(f11144b);
        f11145c = valueOf.length() != 0 ? valueOf9.concat(valueOf) : new String(valueOf9);
        ...
        valueOf = String.valueOf(f11144b);
        f11146d = valueOf.length() != 0 ? valueOf9.concat(valueOf) : new String(valueOf9);
        ...
        valueOf = String.valueOf(f11144b);
        f11147e = valueOf.length() != 0 ? valueOf9.concat(valueOf) : new String(valueOf9);
        ...
        f11149g = new StringBuilder(((((((String.valueOf(valueOf).length() + 107) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length()) + String.valueOf(valueOf4).length()) + String.valueOf(valueOf5).length()) + String.valueOf(valueOf6).length()) + String.valueOf(valueOf7).length()).append(valueOf).append(ordinal).append(" AND ").append(valueOf2).append("!=").append(ordinal2).append(" AND ").append(valueOf3).append("!=1").append(" AND ").append(valueOf4).append("!=1").append(" AND ").append(valueOf5).append("!=-1").append(" AND ").append(valueOf6).append(">? AND ").append(valueOf7).append("=-1").toString();
        ...
        valueOf = String.valueOf(f11149g);
        f11150h = valueOf.length() != 0 ? valueOf9.concat(valueOf) : new String(valueOf9);
        ...
        valueOf = String.valueOf(f11149g);
        f11151i = valueOf.length() != 0 ? valueOf9.concat(valueOf) : new String(valueOf9);
        ...
        valueOf = String.valueOf(f11149g);
        f11152j = valueOf.length() != 0 ? valueOf9.concat(valueOf) : new String(valueOf9);
        ...
        valueOf = String.valueOf(f11149g);
        f11153k = valueOf.length() != 0 ? valueOf9.concat(valueOf) : new String(valueOf9);
        valueOf = f11145c;
        valueOf9 = String.valueOf("sms_type");
        f11154l = new StringBuilder((String.valueOf(valueOf).length() + 18) + String.valueOf(valueOf9).length()).append(valueOf).append(" AND ").append(valueOf9).append("!=-1").toString();
        valueOf = f11147e;
        valueOf9 = String.valueOf("sms_type");
        f11155m = new StringBuilder((String.valueOf(valueOf).length() + 18) + String.valueOf(valueOf9).length()).append(valueOf).append(" AND ").append(valueOf9).append("!=-1").toString();
    }
}
