...
public final class dau extends jzl implements OnClickListener {
    ...
    public static dau m11397a(int i, String str) {
        dau dau = new dau();
    ...
    public Dialog mo792a(Bundle bundle) {
        ...
        bko e = fde.m15018e(getArguments().getInt("account_id"));
        ...
        gwb.m1818a(textView, getActivity(), resources, "https://www.google.com/support/hangouts/?hl=%locale%", "blocking", bc.dl);
        this.aj.setOnCheckedChangeListener(new dav(this, textView));
        return new Builder(getActivity()).setView(inflate).setPositiveButton(resources.getString(bc.hR), new daw(this, e)).setNegativeButton(resources.getString(bc.f2931O), null).create();
    }

    public void m11399a(dax dax) {
        this.al = dax;
    }
}
