...
public final class jyd {
    private static final jjv<Paint> f21275a = new jye();
    private static final jjv<Paint> f21276b = new jye();

    public static Bitmap m25407a(Bitmap bitmap) {
        ...
        if (gwb.aI()) {
            jyd.m25410a(canvas, (Paint) f21275a.m24521b());
        } else {
            Paint paint = (Paint) f21276b.m24521b();
            synchronized (paint) {
                jyd.m25410a(canvas, paint);
            }
        }
    ...
    public static Bitmap m25408a(Bitmap bitmap, float f) {
        return jyd.m25409a(bitmap, f, null);
    }

    public static Bitmap m25409a(Bitmap bitmap, float f, Bitmap bitmap2) {
        if (bitmap == null) {
            return null;
        }
    ...
    private static void m25410a(Canvas canvas, Paint paint) {
