    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        switch (i) {
            case 1:
                ...
                mo2943a(parcel.readString(), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
