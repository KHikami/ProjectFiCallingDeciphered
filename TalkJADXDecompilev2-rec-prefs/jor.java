...
public final class jor extends jzl implements OnClickListener {
    ...
    public Dialog mo792a(Bundle bundle) {
        OnClickListener a;
        if (this.ak != null) {
            a = this.ak.m29180a((OnClickListener) this, "NetworkErrorDialogFragment$onClick");
        } else {
            Object obj = this;
        }
    ...
    public void onCancel(DialogInterface dialogInterface) {
        Object obj;
        if (this.ak != null) {
            this.ak.m29183b("NetworkErrorDialogFragment$onCancel");
            obj = 1;
        } else {
            obj = null;
        }
        try {
            ...
            if (obj != null) {
                lkb.m29210b("NetworkErrorDialogFragment$onCancel");
            }
        }
    }
}
