...
public final class jpr {
    private static final Pattern f20743a = Pattern.compile("^(((http(s)?):)?\\/\\/images(\\d)?-.+-opensocial\\.googleusercontent\\.com\\/gadgets\\/proxy\\?)");
    private static int f20744b;

    static String m24954a(int i, String str) {
        if (str == null) {
            return str;
        }
        String str2;
        ...
        return jpr.m24951a(i, i, Uri.parse(str), str2).toString();
    }

    static String m24953a(int i, int i2, String str) {
        if (str == null) {
            return str;
        }
        String str2;
        ...
        return jpr.m24951a(i, i2, Uri.parse(str), str2).toString();
    }

    private static String m24952a() {
    ...
    private static synchronized int m24956b() {
        int i;
    ...
    private static Uri m24951a(int i, int i2, Uri uri, String str) {
    ...
    private static boolean m24955a(String str) {
        if (str == null) {
            return false;
        }
        return f20743a.matcher(str).find();
    }
}
