...
public abstract class dwz extends ContentProvider {
    public static final String f6490a;
    public static final String f6491b;
    public static final String f6492c;
    public static final String f6493d;
    public static final String f6494e;
    public static final Uri f6495f;
    public static final Uri f6496g;
    public static final Uri f6497h;
    public static final String[] f6498i = new String[]{"_id", "contact_lookup_key", "contact_id", "raw_contact_id", "display_name", "avatar_url", "is_frequent", "contact_source", "frequent_order", "person_logging_id", "person_affinity_score"};
    public static final String[] f6499j = new String[]{"_id", "merged_contact_id", "lookup_data_type", "lookup_data", "lookup_data_standardized", "lookup_data_search", "lookup_data_label", "is_hangouts_user", "needs_gaia_ids_resolved", "gaia_id", "avatar_url", "display_name", "last_checked_ts", "lookup_data_display", "detail_logging_id", "detail_affinity_score"};
    private static final String f6500k;
    ...
    static {
        ...
        f6490a = str;
        f6500k = new StringBuilder(String.valueOf(str).length() + 11).append("content://").append(str).append("/").toString();
        ...
        String valueOf = String.valueOf(dwz.m8734a("lookup_data"));
        String valueOf2 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf3 = String.valueOf(dwz.m8734a("lookup_data_standardized"));
        String valueOf4 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf5 = String.valueOf(dwz.m8734a("lookup_data_label"));
        ...
        String valueOf13 = String.valueOf(dwz.m8734a("gaia_id"));
        String valueOf14 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf15 = String.valueOf(dwz.m8734a("avatar_url"));
        String valueOf16 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf17 = String.valueOf(dwz.m8734a("display_name"));
        ...
        String valueOf22 = String.valueOf(dwz.m8734a("lookup_data_display"));
        String valueOf23 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf24 = String.valueOf(dwz.m8734a("detail_logging_id"));
        String valueOf25 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf26 = String.valueOf(dwz.m8734a("detail_affinity_score"));
        ...
        valueOf = String.valueOf(bji.NAME.m5408a());
        ...
        f6492c = new StringBuilder(((((((((String.valueOf(str).length() + 10) + String.valueOf(valueOf).length()) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length()) + String.valueOf(valueOf4).length()) + String.valueOf(valueOf5).length()) + String.valueOf(valueOf6).length()) + String.valueOf(valueOf7).length()) + String.valueOf(valueOf8).length()).append(str).append(valueOf).append("'").append(valueOf2).append(valueOf3).append(", ").append(valueOf4).append(".").append(valueOf5).append(valueOf6).append(valueOf7).append(" FROM ").append(valueOf8).toString();
        ...
        valueOf = String.valueOf(bji.EMAIL.m5408a());
        valueOf2 = String.valueOf(" as ");
        valueOf3 = String.valueOf("search_type");
        ...
        f6493d = new StringBuilder(((((((((String.valueOf(str).length() + 10) + String.valueOf(valueOf).length()) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length()) + String.valueOf(valueOf4).length()) + String.valueOf(valueOf5).length()) + String.valueOf(valueOf6).length()) + String.valueOf(valueOf7).length()) + String.valueOf(valueOf8).length()).append(str).append(valueOf).append("'").append(valueOf2).append(valueOf3).append(", ").append(valueOf4).append(".").append(valueOf5).append(valueOf6).append(valueOf7).append(" FROM ").append(valueOf8).toString();
        ...
        valueOf = String.valueOf(bji.PHONE.m5408a());
        valueOf2 = String.valueOf(" as ");
        valueOf3 = String.valueOf("search_type");
        valueOf4 = String.valueOf("merged_contact_details");
        ...
        valueOf7 = String.valueOf("search_index");
        valueOf8 = String.valueOf("merged_contact_details");
        f6494e = new StringBuilder(((((((((String.valueOf(str).length() + 10) + String.valueOf(valueOf).length()) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length()) + String.valueOf(valueOf4).length()) + String.valueOf(valueOf5).length()) + String.valueOf(valueOf6).length()) + String.valueOf(valueOf7).length()) + String.valueOf(valueOf8).length()).append(str).append(valueOf).append("'").append(valueOf2).append(valueOf3).append(", ").append(valueOf4).append(".").append(valueOf5).append(valueOf6).append(valueOf7).append(" FROM ").append(valueOf8).toString();
        valueOf = String.valueOf(f6500k);
        str = String.valueOf("merged_contacts");
        f6495f = Uri.parse(str.length() != 0 ? valueOf.concat(str) : new String(valueOf));
        valueOf = String.valueOf(f6500k);
        str = String.valueOf("merged_contacts_with_details");
        f6496g = Uri.parse(str.length() != 0 ? valueOf.concat(str) : new String(valueOf));
        valueOf = String.valueOf(f6500k);
        str = String.valueOf("merged_contact_details");
        f6497h = Uri.parse(str.length() != 0 ? valueOf.concat(str) : new String(valueOf));
    }

    public static String[] m8735a() {
    ...
    public static String[] m8737c() {
        return new String[]{f6491b, f6492c, f6493d, f6494e};
    }

    private static String m8734a(String str) {
