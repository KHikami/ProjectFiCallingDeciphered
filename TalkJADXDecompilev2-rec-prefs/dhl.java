...
public final class dhl extends dq implements OnClickListener {
    public static dhl m11823a(String str, int i) {
        dhl dhl = new dhl();
    ...
    public Dialog mo792a(Bundle bundle) {
        ...
        builder.setMessage(dhl.m11824a(getContext(), arguments.getString("key_error_message"), arguments.getInt("KEY_ERROR")));
    ...
    public void onCancel(DialogInterface dialogInterface) {
        ...
        if (hangoutActivity != null) {
            hangoutActivity.m8568n();
        }
    }

    public static String m11824a(Context context, String str, int i) {
        if (str != null) {
            return str;
        }
        int i2 = bc.dJ;
        switch (i) {
            ...
            case 10018:
                ...
                break;
            case 10019:
                iil.m21870a("This should be handled differently");
                break;
            case 10020:
                i2 = bc.dw;
                break;
            ...
            case 11019:
                ...
                break;
            default:
                iil.m21870a("Unknown/unexpected error code:" + i);
                break;
        }
