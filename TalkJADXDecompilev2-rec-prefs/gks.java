...
public final class gks {
    private static final boolean f15512a = false;

    static {
        kae kae = glk.f15573t;
    }

    public static int m17891a(int i, int i2, int i3, String str) {
        if (i == -1) {
            return i3;
        }
        String valueOf;
        SharedPreferences sharedPreferences = gwb.m1400H().getSharedPreferences("notificationRequestCodes.v1", 0);
        if (str == null) {
    ...
    public static int m17890a(int i) {
        return i;
    }
}
