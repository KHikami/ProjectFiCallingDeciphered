...
interface ebi {
    public static final String[] f11098a = new String[]{"author_first_name", "type", "conversation_id", "conversation_name", "generated_name", "conversation_type", "timestamp", "participant_keys", "call_media_type"};
    public static final String f11099b;
    ...
    static {
        ...
        f11099b = new StringBuilder(((((((String.valueOf(valueOf).length() + 93) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length()) + String.valueOf(valueOf4).length()) + String.valueOf(valueOf5).length()) + String.valueOf(valueOf6).length()) + String.valueOf(valueOf7).length()).append(valueOf).append(ordinal).append(" OR ").append(valueOf2).append("=").append(ordinal2).append(") AND ").append(valueOf3).append("!=1").append(" AND ").append(valueOf4).append(">").append(valueOf5).append(" AND ").append(valueOf6).append(" IS NOT NULL AND ").append(valueOf7).append(" > 1355097600000000").toString();
    }
}
