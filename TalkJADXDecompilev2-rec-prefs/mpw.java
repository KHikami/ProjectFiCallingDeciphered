...
public enum mpw {
    ...
    public static final Map<Character, mpw> f28068F = null;
    private final char f28096G;
    ...
    static {
        ...
        while (i < length) {
            mpw mpw = values[i];
            if (hashMap.put(Character.valueOf(mpw.f28096G), mpw) != null) {
        ...
        f28068F = Collections.unmodifiableMap(hashMap);
    }
