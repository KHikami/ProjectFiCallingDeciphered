...
public final class ajg implements HttpClient {
    public static long f1003a = 256;
    static final HttpRequestInterceptor f1004b = new ajh();
    private static String[] f1005d = new String[]{"text/", "application/xml", "application/json"};
    volatile ajk f1006c;
    private final HttpClient f1007e;
    private RuntimeException f1008f = new IllegalStateException("AndroidHttpClient created and never closed");

    public static ajg m2635a(String str, Context context, boolean z) {
    ...
    private ajg(ClientConnectionManager clientConnectionManager, HttpParams httpParams) {
        this.f1007e = new aji(this, clientConnectionManager, httpParams);
    }

    protected void finalize() {
        super.finalize();
        if (this.f1008f != null) {
            Log.e("MmsHttpClient", "Leak found", this.f1008f);
            this.f1008f = null;
        }
    }
    ...
    public HttpParams getParams() {
        return this.f1007e.getParams();
    }

    public ClientConnectionManager getConnectionManager() {
        return this.f1007e.getConnectionManager();
    }

    public HttpResponse execute(HttpUriRequest httpUriRequest) {
        return this.f1007e.execute(httpUriRequest);
    }

    public HttpResponse execute(HttpUriRequest httpUriRequest, HttpContext httpContext) {
        return this.f1007e.execute(httpUriRequest, httpContext);
    }

    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest) {
        return this.f1007e.execute(httpHost, httpRequest);
    }

    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        return this.f1007e.execute(httpHost, httpRequest, httpContext);
    }

    public <T> T execute(HttpUriRequest httpUriRequest, ResponseHandler<? extends T> responseHandler) {
        return this.f1007e.execute(httpUriRequest, responseHandler);
    }

    public <T> T execute(HttpUriRequest httpUriRequest, ResponseHandler<? extends T> responseHandler, HttpContext httpContext) {
        return this.f1007e.execute(httpUriRequest, responseHandler, httpContext);
    }

    public <T> T execute(HttpHost httpHost, HttpRequest httpRequest, ResponseHandler<? extends T> responseHandler) {
        return this.f1007e.execute(httpHost, httpRequest, responseHandler);
    }

    public <T> T execute(HttpHost httpHost, HttpRequest httpRequest, ResponseHandler<? extends T> responseHandler, HttpContext httpContext) {
        return this.f1007e.execute(httpHost, httpRequest, responseHandler, httpContext);
    }

    static String m2636a(HttpUriRequest httpUriRequest, boolean z) {
        Object uri;
        HttpEntity entity;
    ...
    private static boolean m2637a(HttpUriRequest httpUriRequest) {
