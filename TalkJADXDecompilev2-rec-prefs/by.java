...
public final class by {
    ...
    public by(by byVar) {
        this.f4762a = byVar.f4762a;
        this.f4763b = gwb.m1952a(byVar.f4763b, 0, byVar.f4763b.length);
    }

    static void m6907a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double toRadians;
        double cos;
        double sin;
        double d;
        ...
        d6 *= (double) f5;
        d = ((double) f6) * d5;
        by.m6906a(path2, (d6 * cos) - (d * sin), (d6 * sin) + (cos * d), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d3);
    }

    private static void m6906a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
