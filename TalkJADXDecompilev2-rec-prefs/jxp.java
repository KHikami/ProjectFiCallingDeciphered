...
public final class jxp {
    ...
    public void m25392a(Throwable th, String str) {
        jxp.m25389a(this.f21256a, th, str);
    }

    public static void m25389a(Context context, Throwable th, String str) {
        Intent b = jxp.m25391b(context, th, str);
        if (b != null) {
            context.startService(b);
        }
    }

    private static void m25390a(Throwable th, StringBuilder stringBuilder, Set<Throwable> set, String str) {
        while (th != null && !set.contains(th)) {
            ...
            if (VERSION.SDK_INT >= 19) {
                for (Throwable a : th.getSuppressed()) {
                    jxp.m25390a(a, stringBuilder, set, "\nSuppressed: ");
                }
            }
            if (th.getCause() != null) {
                th = th.getCause();
    ...
    private static Intent m25391b(Context context, Throwable th, String str) {
        ...
        try {
            ...
            jxp.m25390a(th, stringBuilder, new HashSet(), null);
