...
final class hmb implements hlz {
    private IBinder f17084a;

    hmb(IBinder iBinder) {
        this.f17084a = iBinder;
    }

    public LatLng mo2707a(gyj gyj) {
        LatLng latLng = null;
        ...
        try {
            ...
            this.f17084a.transact(1, obtain, obtain2, 0);
    ...
    public VisibleRegion mo2708a() {
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IProjectionDelegate");
            this.f17084a.transact(3, obtain, obtain2, 0);
            obtain2.readException();
    ...
    public gyj mo2709a(LatLng latLng) {
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IProjectionDelegate");
            ...
            this.f17084a.transact(2, obtain, obtain2, 0);
            obtain2.readException();
