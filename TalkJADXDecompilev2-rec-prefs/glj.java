...
public final class glj {
    private static long f15547a = -1;
    private static long f15548b = -1;
    private static long f15549c = -1;
    private static long f15550d = -1;

    public static CharSequence m17960a(Context context, long j, long j2, int i) {
        if (j <= 0 || j2 <= 0) {
            return null;
        }
        long j3 = j2 - j;
        if (j3 <= -900000) {
            glk.m17982e("Babel", "The given start time comes after the current time", new Object[0]);
            return null;
        }
        Resources resources = context.getResources();
        long b = glj.m17964b(j, j2);
    ...
    public static boolean m17962a(long j, long j2) {
    ...
    public static CharSequence m17958a(long j, long j2, boolean z) {
        return glj.m17959a(j, j2, true, 0, z);
    }

    public static CharSequence m17966b(long j, long j2, boolean z) {
        return glj.m17959a(j, j2, false, 0, z);
    }

    public static CharSequence m17957a(long j) {
        return DateUtils.formatDateTime(gwb.m1400H(), j, 21);
    }

    private static CharSequence m17959a(long j, long j2, boolean z, int i, boolean z2) {
        long j3 = j2 - j;
        if (j3 < 60000) {
            return gwb.m1400H().getResources().getText(gwb.wO);
        }
        if (j3 < 3600000) {
            String quantityString;
            long j4 = j3 / 60000;
            if (z2) {
                quantityString = gwb.m1400H().getResources().getQuantityString(gwb.wo, (int) j4);
            } else {
                quantityString = gwb.m1400H().getResources().getQuantityString(gwb.wD, (int) j4);
            }
            return String.format(quantityString, new Object[]{Long.valueOf(j4)});
        } else if (glj.m17964b(j, j2) == 0) {
            return DateUtils.formatDateTime(gwb.m1400H(), j, 1);
        } else {
            Context H;
            if (j3 < 604800000) {
                H = gwb.m1400H();
    ...
    public static CharSequence m17965b(long j) {
        int i;
        long a = glj.m17956a();
    ...
    private static long m17964b(long j, long j2) {
        TimeZone timeZone = TimeZone.getDefault();
        return ((((long) timeZone.getOffset(j2)) + j2) / 86400000) - ((((long) timeZone.getOffset(j)) + j) / 86400000);
    }

    public static String m17961a(long j, boolean z, boolean z2) {
        String quantityString;
        int i = (int) (j / 60000);
    ...
    public static long m17956a() {
        if (f15547a < 0) {
            return System.currentTimeMillis();
        }
        return (System.currentTimeMillis() - f15547a) + f15549c;
    }

    public static long m17963b() {
        if (f15548b < 0) {
            return SystemClock.elapsedRealtime();
        }
        return (SystemClock.elapsedRealtime() - f15548b) + f15550d;
    }
}
