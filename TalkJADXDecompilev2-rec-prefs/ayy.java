...
public final class ayy {
    ...
    public List<ayx> m4389a() {
        List<ayx> arrayList = new ArrayList();
        try {
            ApplicationInfo applicationInfo = this.f2571a.getPackageManager().getApplicationInfo(this.f2571a.getPackageName(), 128);
    ...
    private static ayx m4388a(String str) {
        Throwable e;
        String valueOf;
        try {
