...
final class apa {
    private static final aov f1985a = new aov();
    private final aov f1986b;
    private final aoz f1987c;
    private final aqy f1988d;
    private final ContentResolver f1989e;

    public java.io.InputStream m3603b(android.net.Uri r9) {
...
*/
    ...
    public apa(aoz aoz, aqy aqy, ContentResolver contentResolver) {
        this(f1985a, aoz, aqy, contentResolver);
    }
    ...
    private apa(aov aov, aoz aoz, aqy aqy, ContentResolver contentResolver) {
        ...
        this.f1987c = aoz;
        this.f1988d = aqy;
        this.f1989e = contentResolver;
    }

    public int m3602a(Uri uri) {
        int i = -1;
        InputStream inputStream = null;
        try {
            inputStream = this.f1989e.openInputStream(uri);
            i = new ImageHeaderParser(inputStream, this.f1988d).m8218c();
            if (inputStream != null) {
                try {
                    inputStream.close();
                } catch (IOException e) {
