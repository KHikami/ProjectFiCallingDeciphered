...
final class anh {
    static final Charset f1870a = Charset.forName("US-ASCII");
    static final Charset f1871b = Charset.forName("UTF-8");

    static void m3470a(File file) {
    ...
    static void m3469a(Closeable closeable) {
        try {
            closeable.close();
