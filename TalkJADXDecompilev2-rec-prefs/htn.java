...
public final class htn implements OnClickListener {
    final /* synthetic */ SelectedAccountNavigationView f17258a;

    public htn(SelectedAccountNavigationView selectedAccountNavigationView) {
        this.f17258a = selectedAccountNavigationView;
    }

    public void onClick(View view) {
        if (!(this.f17258a.f7779h == null || this.f17258a.f7772a == null || this.f17258a.f7772a.size() < 2)) {
            C0000a c0000a = this.f17258a.f7779h;
            this.f17258a.f7772a.get(1);
            if (c0000a.m16m()) {
                return;
            }
        }
        SelectedAccountNavigationView selectedAccountNavigationView = this.f17258a;
        if (selectedAccountNavigationView.f7772a != null && selectedAccountNavigationView.f7772a.size() != 0) {
            AnimatorSet animatorSet = new AnimatorSet();
            View view2 = selectedAccountNavigationView.f7775d.f10864t;
            View view3 = selectedAccountNavigationView.f7775d.f10868x;
            view2.bringToFront();
            hwn hwn = (hwn) selectedAccountNavigationView.f7772a.get(1);
            ...
            View view4 = selectedAccountNavigationView.f7775d.f10850E;
            ImageView imageView = selectedAccountNavigationView.f7775d.f10853H;
            if (imageView != null) {
            ...
            selectedAccountNavigationView.f7773b = (hwn) selectedAccountNavigationView.f7772a.get(1);
            selectedAccountNavigationView.f7772a.add(1, hwn2);
            selectedAccountNavigationView.f7772a.remove(2);
