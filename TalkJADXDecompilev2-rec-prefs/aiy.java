...
public final class aiy {
    private DrmManagerClient f974a;
    private int f975b;

    private aiy(DrmManagerClient drmManagerClient, int i) {
        this.f974a = drmManagerClient;
        this.f975b = i;
    }

    public static aiy m2582a(Context context, String str) {
        int i;
    ...
    public byte[] m2584a(byte[] bArr, int i) {
        if (bArr != null) {
            try {
                ...
                if (i != bArr.length) {
                    ...
                    convertData = this.f974a.convertData(this.f975b, obj);
                } else {
                    convertData = this.f974a.convertData(this.f975b, bArr);
                }
                ...
                new StringBuilder(67).append("Buffer with data to convert is illegal. Convertsession: ").append(this.f975b);
                return null;
            } catch (IllegalStateException e2) {
                new StringBuilder(51).append("Could not convert data. Convertsession: ").append(this.f975b);
                return null;
            }
        }
    ...
    public int m2583a(String str) {
        RandomAccessFile randomAccessFile;
        RandomAccessFile randomAccessFile2;
        Throwable th;
        int i = 492;
        int i2 = 491;
        if (this.f974a != null && this.f975b >= 0) {
            try {
                DrmConvertedStatus closeConvertSession = this.f974a.closeConvertSession(this.f975b);
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                new StringBuilder(59).append("Could not close convertsession. Convertsession: ").append(this.f975b);
                                return i;
                            }
                        }
