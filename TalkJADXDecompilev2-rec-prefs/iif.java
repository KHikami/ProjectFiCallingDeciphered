...
public final class iif {
    public static final SparseArray<iig> f17725a;
    ...
    static {
        ...
        sparseArray.put(500, new iig(500, 501));
        sparseArray.put(501, new iig(500, HttpStatusCodes.STATUS_CODE_BAD_GATEWAY));
        sparseArray.put(HttpStatusCodes.STATUS_CODE_BAD_GATEWAY, new iig(500, HttpStatusCodes.STATUS_CODE_SERVICE_UNAVAILABLE));
        f17725a = sparseArray;
    }
}
