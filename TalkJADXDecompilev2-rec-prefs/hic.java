    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        switch (i) {
            case 2:
                ...
                mo2551a(parcel.readInt() != 0 ? (Status) Status.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (PredictedNetworkQuality) PredictedNetworkQuality.CREATOR.createFromParcel(parcel) : null);
                return true;
            case 1598968902:
