...
public final class aia {
    private static byte[] f909a = new byte[255];
    ...
    static {
        ...
        for (i = 122; i >= 97; i--) {
            f909a[i] = (byte) ((i - 97) + 26);
        }
        for (i = 57; i >= 48; i--) {
            f909a[i] = (byte) ((i - 48) + 52);
        }
        f909a[43] = (byte) 62;
        f909a[47] = (byte) 63;
    }

    public static byte[] m2436a(byte[] bArr) {
        int i;
        int i2 = 0;
        ...
        while (i2 < length) {
            ...
            byte b2 = obj2[i5 + 2];
            byte b3 = obj2[i5 + 3];
            byte b4 = f909a[obj2[i5]];
            byte b5 = f909a[obj2[i5 + 1]];
