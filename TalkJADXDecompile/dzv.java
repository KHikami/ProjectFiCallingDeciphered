...
public final class dzv implements dzx {
    ...
    private void b(long j) {
        ...
        synchronized (this.g) {
            ...
            if (a) {
                ...
                String str3 = this.c;
                new StringBuilder((String.valueOf(str3).length() + 38) + String.valueOf(str2).length()).append("pausing queue ").append(str3).append("[").append(this.e.size()).append("]; duration ").append(str2);
            }
            try {
                if (h()) {
                    return;
                ...
                if (a) {
                    str = this.c;
                    new StringBuilder(String.valueOf(str).length() + 20).append("/pause ").append(str).append("[").append(this.e.size()).append("]");
                }
            } catch (InterruptedException e) {
                String str4 = "Babel_NetworkQueue";
                str2 = "InterruptedException in pauseQueue: ";
                str = String.valueOf(e.toString());
                glk.d(str4, str.length() != 0 ? str2.concat(str) : new String(str2), new Object[0]);
            }
        }
    }
    ...
    L_0x0039:
        ...
        glk.e(r0, r2, r3);	 Catch:{ all -> 0x004d }
