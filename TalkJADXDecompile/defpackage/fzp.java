...
public final class fzp {
    ...
    public static fzp a(Cursor cursor, boolean z) {
        ...
        str = string2 != null ? string2.trim() : string2;
        ...
        if (z) {
            ...
            try {
                ...
                string3 = String.valueOf(e2);
                glk.e("Babel_SMS", new StringBuilder(String.valueOf(string3).length() + 58).append("TransactionSettings.Apn.fromCursor: invalid current value ").append(string3).toString(), new Object[0]);
            }
            str4 = null;
            str5 = null;
            str6 = null;
            ...
            return new fzp(j, b, str3, i, i2, str4, str5, str6, str7, str2, string2, string, str8);
        }
        i2 = 0;
        str4 = null;
        str5 = null;
