...
public final class gsl {
    ...
    public static synchronized defpackage.gsl a(android.content.ContentResolver r8) {
        /*
        r2 = defpackage.gsl.class;
        monitor-enter(r2);
        r3 = defpackage.icb.a(r8);	 Catch:{ all -> 0x008f }
    ...
    L_0x0022:
        ...
        r0 = defpackage.icb.a(r8, r0);	 Catch:{ all -> 0x008f }
    ...
    L_0x0041:
        ...
        r1 = r0.getKey();	 Catch:{ gsn -> 0x0086 }
        r1 = (java.lang.String) r1;	 Catch:{ gsn -> 0x0086 }
        r6 = 4;
        r1 = r1.substring(r6);	 Catch:{ gsn -> 0x0086 }
        r0 = r0.getValue();	 Catch:{ gsn -> 0x0086 }
        r0 = (java.lang.String) r0;	 Catch:{ gsn -> 0x0086 }
        if (r0 == 0) goto L_0x003b;
    L_0x005a:
        r6 = r0.length();	 Catch:{ gsn -> 0x0086 }
        if (r6 == 0) goto L_0x003b;
    L_0x0060:
        r6 = "UrlRules";
        r7 = 2;
        r6 = android.util.Log.isLoggable(r6, r7);	 Catch:{ gsn -> 0x0086 }
        if (r6 == 0) goto L_0x007d;
    L_0x0069:
        r6 = new java.lang.StringBuilder;	 Catch:{ gsn -> 0x0086 }
        r7 = "  Rule ";
        r6.<init>(r7);	 Catch:{ gsn -> 0x0086 }
        r6 = r6.append(r1);	 Catch:{ gsn -> 0x0086 }
        r7 = ": ";
        r6 = r6.append(r7);	 Catch:{ gsn -> 0x0086 }
        r6.append(r0);	 Catch:{ gsn -> 0x0086 }
    L_0x007d:
        r6 = new gsm;	 Catch:{ gsn -> 0x0086 }
        r6.<init>(r1, r0);	 Catch:{ gsn -> 0x0086 }
        r4.add(r6);	 Catch:{ gsn -> 0x0086 }
        goto L_0x003b;
    L_0x0086:
        r0 = move-exception;
        r1 = "UrlRules";
    ...
    L_0x008f:
        ...
        throw r0;
    L_0x0092:
        r1 = new gsl;	 Catch:{ all -> 0x008f }
        r0 = r4.size();	 Catch:{ all -> 0x008f }
        r0 = new defpackage.gsm[r0];	 Catch:{ all -> 0x008f }
        r0 = r4.toArray(r0);	 Catch:{ all -> 0x008f }
        r0 = (defpackage.gsm[]) r0;	 Catch:{ all -> 0x008f }
    ...
    L_0x00ba:
        ...
        goto L_0x0020;
        */
        throw new UnsupportedOperationException("Method not decompiled: gsl.a(android.content.ContentResolver):gsl");
    }
}
