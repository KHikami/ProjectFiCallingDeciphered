    ...
    public final int a(Context context, bhb bhb) {
        ...
        if (this.d == -1 || ((long) this.e) <= this.d) {
            ...
            if (a2 == null) {
                ...
                glk.e("Babel_Grpc", new StringBuilder(String.valueOf(valueOf2).length() + 66).append("Send request ").append(valueOf2).append(" unable to get the grpc stub. The grpc channel is NA.").toString(), new Object[0]);
                return bhn.b;
            }
            String b = b.b(e());
            String valueOf3;
            try {
                ...
                glk.a("Babel_Grpc", new StringBuilder(String.valueOf(valueOf3).length() + 45).append("Sending request ").append(valueOf3).append(" at retry attempt ").append(this.e).toString(), new Object[0]);
                a(context, a2);
                return bhn.a;
            } catch (fdo e) {
                a = a(context, e);
                ...
                valueOf3 = String.valueOf(e());
                valueOf2 = String.valueOf(atomicReference.get());
                valueOf = String.valueOf(atomicReference2.get());
                glk.e("Babel_Grpc", new StringBuilder(((String.valueOf(valueOf3).length() + 56) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf).length()).append("Send request ").append(valueOf3).append(" grpc headers capture: ").append(valueOf2).append("\n trailers capture: ").append(valueOf).toString(), new Object[0]);
                olv a3 = olv.a(e2);
            ...
            a(context, new fdo(109, new StringBuilder(String.valueOf(valueOf).length() + 66).append("Send request ").append(valueOf).append(" exceeds maximum allowed retries ").append(this.d).toString()));
            return bhn.d;
        }
    }
