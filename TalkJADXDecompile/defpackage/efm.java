...
public final class efm {
    ...
    static {
        ...
        c = a + 2;
        d = a + 3;
        String valueOf = String.valueOf(efm.a(true));
        ...
        valueOf = String.valueOf(efm.a(true));
    ...
    public static String a(List<String> list, List<String> list2) {
        if (list.size() == 1) {
            ...
            efm.a(stringBuilder, list, list2);
            stringBuilder.append(" UNION ");
            efm.b(stringBuilder, list, list2);
            stringBuilder.append(" UNION ");
            efm.c(stringBuilder, list, list2);
        ...
        efm.d(stringBuilder, list, list2);
