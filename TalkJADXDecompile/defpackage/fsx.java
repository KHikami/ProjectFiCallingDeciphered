...
public final class fsx implements hwk {
    ...
    public void a(MessageDigest messageDigest) {
        byte b;
        int i = 0;
        fsx.a(messageDigest, a());
        fsx.a(messageDigest, j());
        for (Long a : this.c) {
            long a2 = gwb.a(a);
        ...
        for (hwm hwm : c()) {
            fsx.a(messageDigest, hwm.a());
            fsx.a(messageDigest, hwm.b());
        }
        for (hwr hwr : d()) {
            fsx.a(messageDigest, hwr.a());
            fsx.a(messageDigest, hwr.b());
        }
        fsx.a(messageDigest, this.f);
        if (this.g) {
            b = (byte) 1;
        } else {
            b = (byte) 0;
        ...
        fsx.a(messageDigest, this.h);
        fsx.a(messageDigest, this.i);
        String[] strArr = this.j;
        int length = strArr.length;
        while (i < length) {
            fsx.a(messageDigest, strArr[i]);
            i++;
        }
    }
