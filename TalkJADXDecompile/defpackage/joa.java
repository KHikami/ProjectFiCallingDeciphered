...
public final class joa extends jzn implements jcs, jgf, jmo {
    ...
    public joa() {
        this.f = new jgg((dr) this, this.lifecycle).a((jgf) this);
        this.g = new jio(this.lifecycle);
        this.al = -1;
    }

    static {
        a = new String[]{"update_account", "prepare_accounts", "logout_during_login", "logout", "load_accounts_add", "load_accounts_add_account_activity", "are_accounts_ready_for_login"};
    }
