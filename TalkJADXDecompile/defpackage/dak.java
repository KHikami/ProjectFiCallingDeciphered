...
public final class dak implements Serializable {
    ...
    private static dak a(Context context, List<hwk> list, String str) {
        ...
        if (str2 != null && obj == null) {
            ...
            glk.e(str2, str3.length() != 0 ? a.concat(str3) : new String(a), new Object[0]);
        }
        return new dak(str4, e, h, arrayList2, arrayList3, arrayList);
    }
    ...
    private static dak a(Context context, Iterable<bjg> iterable, String str) {
        ...
        if (str2 != null && obj == null) {
            ...
            glk.e(str2, str7.length() != 0 ? e.concat(str7) : new String(e), new Object[0]);
        }
