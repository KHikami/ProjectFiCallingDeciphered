...
public class ain {
    ...
    protected aim a(ByteArrayInputStream byteArrayInputStream) {
        ...
        while (i != 0 && byteArrayInputStream.available() > 0) {
            ...
            int f2 = ain.f(byteArrayInputStream);
            if (f2 < 32 || f2 > 127) {
                byte[] b;
                int indexOf;
                byte[] a;
                ...
                switch (f2) {
                    ...
                    case 130:
                    case 151:
                        aic e2 = ain.e(byteArrayInputStream);
                        if (e2 != null) {
                            b = e2.b();
                            if (b != null) {
                    ...
                    case 189:
                    case 190:
                        a = ain.a(byteArrayInputStream, 0);
                        if (a != null) {
                            try {
                                aim.a(a, f2);
                                break;
                    ...
                    case 132:
                        ...
                        byte[] a2 = ain.a(byteArrayInputStream, sparseArray);
                        if (a2 != null) {
                            try {
                                aim.a(a2, 132);
                    ...
                    case 159:
                        try {
                            aim.a(ain.h(byteArrayInputStream), f2);
                            break;
                    ...
                    case 136:
                    case 157:
                        ain.d(byteArrayInputStream);
                        indexOf = ain.f(byteArrayInputStream);
                        try {
                            long h = ain.h(byteArrayInputStream);
                            if (129 == indexOf) {
                    ...
                    case 137:
                        ain.d(byteArrayInputStream);
                        if (128 == ain.f(byteArrayInputStream)) {
                            e = ain.e(byteArrayInputStream);
                            if (e != null) {
                                b = e.b();
                                if (b != null) {
                    ...
                    case 161:
                        ...
                        try {
                            ain.i(byteArrayInputStream);
                            try {
                                aim.a(ain.h(byteArrayInputStream), 161);
                                break;
                    ...
                    case 164:
                        ain.d(byteArrayInputStream);
                        ain.f(byteArrayInputStream);
                        ain.e(byteArrayInputStream);
                        break;
                    case 170:
                    case 172:
                        ain.d(byteArrayInputStream);
                    ...
                    case 179:
                        try {
                            aim.a(ain.i(byteArrayInputStream), f2);
                            break;
                    ...
                    case 178:
                        ain.a(byteArrayInputStream, null);
                        break;
                    default:
                        break;
                }
    ...
    private static aig b(ByteArrayInputStream byteArrayInputStream) {
        ...
        int c = ain.c(byteArrayInputStream);
        aig aig = new aig();
        for (int i = 0; i < c; i++) {
            int c2 = ain.c(byteArrayInputStream);
            int c3 = ain.c(byteArrayInputStream);
            aio aio = new aio();
            ...
            if (available2 > 0) {
                if (!ain.a(byteArrayInputStream, aio, available2)) {
                    return null;
                }
            ...
            if (c3 > 0) {
                ...
                if (str.equalsIgnoreCase("application/vnd.wap.multipart.alternative")) {
                    a = ain.b(new ByteArrayInputStream(a2)).a(0);
                    if (!(d == null && e == null)) {
                        if (e == null) {
                            c4 = a.c();
    ...
    private static int d(ByteArrayInputStream byteArrayInputStream) {
        ...
        if (read == 31) {
            return ain.c(byteArrayInputStream);
        }
    ...
    private static aic e(ByteArrayInputStream byteArrayInputStream) {
        ...
        if (read < 32) {
            ain.d(byteArrayInputStream);
            read = ain.g(byteArrayInputStream);
        } else {
            read = 0;
        }
        byte[] a = ain.a(byteArrayInputStream, 0);
        if (read == 0) {
            return new aic(a);
        }
        try {
    ...
    private static long i(ByteArrayInputStream byteArrayInputStream) {
        ...
        byteArrayInputStream.reset();
        if (read > 127) {
            return (long) ain.g(byteArrayInputStream);
        }
        return ain.h(byteArrayInputStream);
    }
    ...
    private static byte[] a(ByteArrayInputStream byteArrayInputStream, SparseArray<Object> sparseArray) {
        ...
        if (read < 32) {
            byte[] a;
            int d = ain.d(byteArrayInputStream);
            int available = byteArrayInputStream.available();
            byteArrayInputStream.mark(1);
            read = byteArrayInputStream.read();
            byteArrayInputStream.reset();
            ...
            if (available > 0) {
                ...
                while (d > 0) {
                    ...
                    switch (byteArrayInputStream.read()) {
                        case 129:
                            byteArrayInputStream.mark(1);
                            d = ain.f(byteArrayInputStream);
                            byteArrayInputStream.reset();
                            if ((d <= 32 || d >= 127) && d != 0) {
                                d = (int) ain.i(byteArrayInputStream);
                                if (sparseArray != null) {
                                    sparseArray.put(129, Integer.valueOf(d));
                                }
                            } else {
                                byte[] a3 = ain.a(byteArrayInputStream, 0);
                                try {
                        ...
                        case 137:
                            ...
                            byteArrayInputStream.reset();
                            if (d > 127) {
                                d = ain.g(byteArrayInputStream);
                                if (d < ail.a.length) {
                                    sparseArray.put(131, ail.a[d].getBytes());
                                }
                            } else {
                                a2 = ain.a(byteArrayInputStream, 0);
                        ...
                        case 153:
                            ...
                            break;
                        default:
                            if (-1 != ain.b(byteArrayInputStream, d)) {
                                d = 0;
                                break;
                            }
                            Log.e("PduParser", "Corrupt Content-Type");
            ...
            return ain.a(byteArrayInputStream, 0);
        } else {
            return ail.a[ain.g(byteArrayInputStream)].getBytes();
        }
    }
            ...
            if (read > 127) {
                switch (read) {
                    ...
                    case 197:
                        ...
                        break;
                    case 192:
                        a = ain.a(byteArrayInputStream, 1);
                        if (a != null) {
                            aio.b(a);
                        }
                        i2 = i - (available - byteArrayInputStream.available());
                        break;
                    default:
                        if (-1 != ain.b(byteArrayInputStream, i2)) {
                            i2 = 0;
                            break;
                        }
                ...
                a = ain.a(byteArrayInputStream, 0);
                byte[] a2 = ain.a(byteArrayInputStream, 0);
                if (true == "Content-Transfer-Encoding".equalsIgnoreCase(new String(a))) {
                    aio.f(a2);
                }
                i2 = i - (available - byteArrayInputStream.available());
            } else if (-1 == ain.b(byteArrayInputStream, i2)) {
                Log.e("PduParser", "Corrupt Part headers");
                return false;
            } else {
                i2 = 0;
