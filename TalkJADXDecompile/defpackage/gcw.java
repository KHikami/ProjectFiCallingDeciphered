    ...
    static gcw a(Context context, String str, boolean z, gfv gfv) {
        ...
        if (gfv.a) {
            ...
            if (!TextUtils.isEmpty(a) && !a.equals(gwb.G(context))) {
                ...
                glk.c(a, b.length() != 0 ? str2.concat(b) : new String(str2), new Object[0]);
                return null;
            } else if (!b.contains("incoming") || z) {
                b = gcw.a(b, "wifi_signal_percent_threshold=");
                if (!TextUtils.isEmpty(b)) {
                    try {
                        if (!gfv.a(Integer.parseInt(b), 0)) {
                            str2 = String.valueOf(gfv);
                            glk.c("Babel_telephony", new StringBuilder((String.valueOf(str2).length() + 68) + String.valueOf(b).length()).append("TeleExperiment.getWifiExperiment, (").append(str2).append(") is not above signal threshold: ").append(b).toString(), new Object[0]);
                            return null;
                        }
