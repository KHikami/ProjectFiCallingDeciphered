...
public final class gef {
    ...
    private boolean a(boolean z) {
        if (z && !gwb.a(this.a, "babel_telephony_allow_proxy_number_routing", true)) {
            ...
            if (this.d.e() != 3 || this.d.c() == 3) {
                ...
                if (gwb.a(this.a, "babel_hutch_use_proxy_numbers_for_calls_to_us", true) && gef.a(this.a, this.d.c()) && Locale.US.getCountry().equals(simCountryIso)) {
    ...
    boolean q() {
        if (this.c) {
            ...
            if (!a(false) && !gef.a(this.a, this.d.c())) {
    ...
    private static boolean c(String str) {
        if (str == null) {
            ...
            return false;
        } else if (str.length() != 10 || !gef.a(str.charAt(0)) || !gef.a(str.charAt(3))) {
            return false;
        } else {
            for (int i = 1; i < 10; i++) {
