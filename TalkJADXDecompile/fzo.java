...
public final class fzo {
    ...
    static {
        a = new String[]{"type", "mmsc", "mmsproxy", "mmsport"};
    }
    ...
    public static fzo a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(b)) {
            ...
            fzo = new fzo();
            fzo.a(new fzp(b, b(gwb.b(gwb.H(), "babel_mms_proxy_address", fls.l)), gwb.a(gwb.H(), "babel_mms_proxy_port", -1)));
        }
        if (fzo == null || !fzo.b()) {
            fzo = b(context, str);
            if (fzo == null || !fzo.b()) {
