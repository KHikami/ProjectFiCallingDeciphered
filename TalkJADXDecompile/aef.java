...
public abstract class aef {
    ...
    public void a(Rect rect, int i, int i2) {
        e(a(i, (rect.width() + B()) + D(), H()), a(i2, (rect.height() + C()) + E(), I()));
    }
    ...
    boolean a(View view, int i, int i2, aeg aeg) {
        return (this.a && b(view.getMeasuredWidth(), i, aeg.width) && b(view.getMeasuredHeight(), i2, aeg.height)) ? false : true;
    }

    boolean b(View view, int i, int i2, aeg aeg) {
        return (!view.isLayoutRequested() && this.a && b(view.getWidth(), i, aeg.width) && b(view.getHeight(), i2, aeg.height)) ? false : true;
    }
    ...
    public void a(View view, int i, int i2) {
        ...
        i3 = a(z(), x(), i3 + (((B() + D()) + aeg.leftMargin) + aeg.rightMargin), aeg.width, h());
        i4 = a(A(), y(), i4 + (((C() + E()) + aeg.topMargin) + aeg.bottomMargin), aeg.height, i());
        if (b(view, i3, i4, aeg)) {
            view.measure(i3, i4);
        }
    }
