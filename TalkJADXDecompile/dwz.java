...
public abstract class dwz extends ContentProvider {
    ...
    static {
        ...
        String valueOf = String.valueOf(a("lookup_data"));
        String valueOf2 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf3 = String.valueOf(a("lookup_data_standardized"));
        String valueOf4 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf5 = String.valueOf(a("lookup_data_label"));
        ...
        String valueOf13 = String.valueOf(a("gaia_id"));
        String valueOf14 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf15 = String.valueOf(a("avatar_url"));
        String valueOf16 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf17 = String.valueOf(a("display_name"));
        ...
        String valueOf22 = String.valueOf(a("lookup_data_display"));
        String valueOf23 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf24 = String.valueOf(a("detail_logging_id"));
        String valueOf25 = String.valueOf(" || \"#DELIM2#\" || ");
        String valueOf26 = String.valueOf(a("detail_affinity_score"));
        ...
        i = new String[]{"_id", "contact_lookup_key", "contact_id", "raw_contact_id", "display_name", "avatar_url", "is_frequent", "contact_source", "frequent_order", "person_logging_id", "person_affinity_score"};
        j = new String[]{"_id", "merged_contact_id", "lookup_data_type", "lookup_data", "lookup_data_standardized", "lookup_data_search", "lookup_data_label", "is_hangouts_user", "needs_gaia_ids_resolved", "gaia_id", "avatar_url", "display_name", "last_checked_ts", "lookup_data_display", "detail_logging_id", "detail_affinity_score"};
    }
