...
public final class izn {
    ...
    public static onv a(int i, int i2, String str, Context context, String str2, boolean z) {
        ...
        onv.a.a = a(processMemoryInfo[0], z);
        onv.b = new oog();
    ...
    private static onf a(MemoryInfo memoryInfo, boolean z) {
        ...
        if (VERSION.SDK_INT >= 23 && !z) {
            try {
                ...
                onf.l = a((String) memoryStats.get("summary.code"));
                onf.m = a((String) memoryStats.get("summary.stack"));
                onf.n = a((String) memoryStats.get("summary.graphics"));
                onf.p = a((String) memoryStats.get("summary.system"));
                onf.k = a((String) memoryStats.get("summary.java-heap"));
                onf.o = a((String) memoryStats.get("summary.private-other"));
