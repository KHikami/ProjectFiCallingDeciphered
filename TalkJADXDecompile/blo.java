...
*/
    ...
    public static long d(String str) {
        return TextUtils.isEmpty(str) ? 0 : gwb.a(c(str));
    }
    ...
    public String a(bls bls) {
        ...
        if (i > 1) {
            ...
            a = String.valueOf(ak(b.a));
            String valueOf = String.valueOf(ak(b.b));
            ...
            for (edk edk2 : bls.h) {
                String valueOf2 = String.valueOf(ak(edk2.b()));
                str2 = String.valueOf(ak(edk2.c()));
                a2 = String.valueOf(ak(edk2.c));
            ...
            for (Integer a3 : jcf.a()) {
                int a4 = gwb.a(a3, -1);
                str2 = String.valueOf(ak(jcf.a(a4).b("gaia_id")));
    ...
    public void a(java.util.HashSet<edo> r14) {
        /*
        r13 = this;
        r12 = 1;
        r11 = 0;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.util.List<eyg> a(boolean r14) {
        /*
        r13 = this;
        r9 = 0;
