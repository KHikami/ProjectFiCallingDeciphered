...
public final class bnz implements bjr, Serializable {
    public static AtomicReference<bod> a = null;
    ...
    public static void a(int i, boc boc, ets ets) {
        ...
        lo a3 = a(a2);
        int a4 = a(a2.a("chat_acl_settings_public", ""));
        int a5 = a(a2.a("chat_acl_settings_phone", ""));
        int a6 = a(a2.a("chat_acl_settings_email", ""));
    ...
    public static void a(int i, int i2, int i3, int i4, List<exf> list) {
        ...
        int a = a((jck) b, "chat_acl_settings_email", b.a("chat_acl_settings_email", ""), g(i4)) | ((a((jck) b, "chat_acl_settings_public", b.a("chat_acl_settings_public", ""), g(i2)) | 0) | a((jck) b, "chat_acl_settings_phone", b.a("chat_acl_settings_phone", ""), g(i3)));
        lo a2 = a(b);
        int size = a2.size();
    ...
    public void a(jck jck, SharedPreferences sharedPreferences, Editor editor) {
        ...
        if (all != null) {
            for (Entry entry : all.entrySet()) {
                boc a = a("chat_acl_settings_circle", (String) entry.getKey());
                if (a != null) {
