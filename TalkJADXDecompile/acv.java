...
public class acv extends ViewGroup {
            ...
            while (i10 < m) {
                ...
                if (c3.getVisibility() != 8) {
                    ...
                    if (f5 > 0.0f) {
                        ...
                        f5 = f - f5;
                        i5 = i4 - i6;
                        i16 = getChildMeasureSpec(i, ((getPaddingLeft() + getPaddingRight()) + acw2.leftMargin) + acw2.rightMargin, acw2.width);
    ...
    void b(int i, int i2) {
        ...
        if (z2 && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            while (i15 < m) {
                ...
                if (c2 == null) {
                    ...
                    acw = (acw) c2.getLayoutParams();
                    if (obj != null) {
                        this.f = (acw.rightMargin + (acw.leftMargin + i8)) + this.f;
                        i3 = i15;
                    } else {
                        measuredHeight = this.f;
                        this.f = Math.max(measuredHeight, acw.rightMargin + ((measuredHeight + i8) + acw.leftMargin));
                        i3 = i15;
                    }
                }
                i15 = i3 + 1;
        ...
        i4 = oa.a(Math.max(this.f, getSuggestedMinimumWidth()), i, 0);
            ...
            while (i7 < m) {
                ...
                if (c3 == null || c3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        f6 = f - f6;
                        measuredHeight -= i15;
                        childMeasureSpec = getChildMeasureSpec(i2, ((getPaddingTop() + getPaddingBottom()) + acw.topMargin) + acw.bottomMargin, acw.height);
                        ...
                        childMeasureSpec = age.a(i10, oa.f(c3) & -16777216);
                        f5 = f6;
                        i12 = measuredHeight;
                    } else {
                        i12 = measuredHeight;
            ...
            if (z2 && mode != 1073741824) {
                for (i15 = 0; i15 < m; i15++) {
                    ...
                    if (!(view == null || view.getVisibility() == 8 || ((acw) view.getLayoutParams()).g <= 0.0f)) {
                        view.measure(MeasureSpec.makeMeasureSpec(i8, 1073741824), MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), 1073741824));
                    }
                }
            }
            i3 = baseline;
        ...
        setMeasuredDimension((-16777216 & i5) | i4, oa.a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i5 << 16));
        if (obj3 != null) {
    ...
    void a(int i, int i2, int i3, int i4) {
        ...
        while (i7 < m) {
            ...
            if (c == null) {
                ...
                i8 += acw.topMargin;
                a(c, i9, i8, measuredWidth, measuredHeight);
