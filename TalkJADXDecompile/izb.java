...
public final class izb {
    ...
    static {
        a = new int[]{5, 11, 23, 47, 97, 197, 397, 797, 1597, 3203, 6421, 12853, 25717, 51437, 102877, 205759, 411527, 823117, 1646237, 3292489, 6584983, 13169977, 26339969, 52679969, 105359939, 210719881, 421439783, 842879579, 1685759167, 2147483629};
    }
    ...
    private int d(int i) {
        ...
        int a = (a(i) & Integer.MAX_VALUE) % length;
