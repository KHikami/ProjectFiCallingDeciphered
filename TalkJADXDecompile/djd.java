...
public final class djd implements dht, dkn, dkp {
    ...
    private static final mjx<isr, isq> t;
    private static final mjx<isq, Integer> u;
    final dgg b;
    final Runnable c;
    final Runnable d;
    ...
    static {
        ...
        t = mjx.a(isr.SPEAKERPHONE_ON, isq.SPEAKERPHONE, isr.BLUETOOTH_ON, isq.BLUETOOTH_HEADSET, isr.EARPIECE_ON, isq.EARPIECE, isr.WIRED_HEADSET_ON, isq.WIRED_HEADSET);
        u = mjx.a(isq.SPEAKERPHONE, Integer.valueOf(2063), isq.BLUETOOTH_HEADSET, Integer.valueOf(2062), isq.EARPIECE, Integer.valueOf(2064), isq.WIRED_HEADSET, Integer.valueOf(2065));
    }
