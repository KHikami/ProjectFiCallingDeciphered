...
public class fcm {
    ...
    public static void a(Context context, String str, OnCancelListener onCancelListener) {
        ...
        a(context, onCancelListener, context.getString(gwb.uE), context.getString(gwb.uD, new Object[]{glq.i(gwb.H(), str)}));
    }
    ...
    public static void b(Context context, String str, OnCancelListener onCancelListener) {
        ...
        a(context, onCancelListener, context.getString(gwb.uB), context.getString(gwb.uA, new Object[]{glq.i(gwb.H(), str)}));
    }
