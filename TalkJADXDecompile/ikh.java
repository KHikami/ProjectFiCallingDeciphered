...
public final class ikh {
    ...
    void a(PrintWriter printWriter) {
        ...
        for (int i = 0; i < this.c.a(); i++) {
            a((ikn) this.c.a(i), printWriter, aggregatePrintStats);
        }
        if (this.i != null) {
            a(this.i, printWriter, aggregatePrintStats);
        }
        ...
        for (Entry entry : this.b.entrySet()) {
            ...
            for (int i2 = 0; i2 < iin.a(); i2++) {
                a((ikn) iin.a(i2), printWriter, aggregatePrintStats);
            }
            for (ikn a : ikk.i.c()) {
                a(a, printWriter, aggregatePrintStats);
            }
        }
