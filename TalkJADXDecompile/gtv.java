...
public class gtv {
    ...
    L_0x0005:
        ...
        r0 = hhg.a;	 Catch:{ NameNotFoundException -> 0x0040, all -> 0x0044 }
        r0 = r0.a(r7);	 Catch:{ NameNotFoundException -> 0x0040, all -> 0x0044 }
        r1 = gxl.a(r7);	 Catch:{ NameNotFoundException -> 0x0040, all -> 0x0044 }
    ...
    L_0x0021:
        r1 = gtw.a(r7);	 Catch:{ NameNotFoundException -> 0x0040, all -> 0x0044 }
        r2 = 1;
        r2 = new gxx[r2];	 Catch:{ NameNotFoundException -> 0x0040, all -> 0x0044 }
        r3 = 0;
        r4 = gya.a;	 Catch:{ NameNotFoundException -> 0x0040, all -> 0x0044 }
        r5 = 1;
