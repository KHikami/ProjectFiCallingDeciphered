...
public class aip {
    ...
    private aio[] a(long r12) {
        ...
        r4 = r3;
        r5 = r3;
        r5 = gwb.a(r0, r1, r2, r3, r4, r5);
        if (r5 == 0) goto L_0x0033;
    L_0x002d:
        r0 = r5.getCount();	 Catch:{ all -> 0x012a }
    ...
    L_0x0039:
        r0 = r5.getCount();	 Catch:{ all -> 0x012a }
        r0 = new aio[r0];	 Catch:{ all -> 0x012a }
        r4 = r6;
    L_0x0040:
        r1 = r5.moveToNext();	 Catch:{ all -> 0x012a }
        if (r1 == 0) goto L_0x0180;
    L_0x0046:
        r6 = new aio;	 Catch:{ all -> 0x012a }
        r6.<init>();	 Catch:{ all -> 0x012a }
        r1 = 1;
        r1 = r5.isNull(r1);	 Catch:{ all -> 0x012a }
        if (r1 != 0) goto L_0x011f;
    L_0x0052:
        r1 = 1;
        r1 = r5.getInt(r1);	 Catch:{ all -> 0x012a }
        r1 = java.lang.Integer.valueOf(r1);	 Catch:{ all -> 0x012a }
        r2 = r1;
    L_0x005c:
        if (r2 == 0) goto L_0x0065;
    L_0x005e:
        r1 = r2.intValue();	 Catch:{ all -> 0x012a }
        r6.a(r1);	 Catch:{ all -> 0x012a }
    L_0x0065:
        r1 = 2;
        r1 = a(r5, r1);	 Catch:{ all -> 0x012a }
        if (r1 == 0) goto L_0x006f;
    L_0x006c:
        r6.d(r1);	 Catch:{ all -> 0x012a }
    L_0x006f:
        r1 = 3;
        r1 = a(r5, r1);	 Catch:{ all -> 0x012a }
        if (r1 == 0) goto L_0x0079;
    L_0x0076:
        r6.b(r1);	 Catch:{ all -> 0x012a }
    L_0x0079:
        r1 = 4;
        r1 = a(r5, r1);	 Catch:{ all -> 0x012a }
    ...
    L_0x008a:
        r6.e(r1);	 Catch:{ all -> 0x012a }
        r7 = 6;
        r7 = a(r5, r7);	 Catch:{ all -> 0x012a }
        if (r7 == 0) goto L_0x0097;
    L_0x0094:
        r6.h(r7);	 Catch:{ all -> 0x012a }
    L_0x0097:
        r7 = 7;
        r7 = a(r5, r7);	 Catch:{ all -> 0x012a }
        if (r7 == 0) goto L_0x00a1;
    L_0x009e:
        r6.g(r7);	 Catch:{ all -> 0x012a }
    L_0x00a1:
        r7 = 0;
        r8 = r5.getLong(r7);	 Catch:{ all -> 0x012a }
        r7 = new java.lang.StringBuilder;	 Catch:{ all -> 0x012a }
        r10 = 39;
        r7.<init>(r10);	 Catch:{ all -> 0x012a }
        r10 = "content://mms/part/";
        r7 = r7.append(r10);	 Catch:{ all -> 0x012a }
        r7 = r7.append(r8);	 Catch:{ all -> 0x012a }
        r7 = r7.toString();	 Catch:{ all -> 0x012a }
        r7 = android.net.Uri.parse(r7);	 Catch:{ all -> 0x012a }
        r6.a(r7);	 Catch:{ all -> 0x012a }
        r1 = a(r1);	 Catch:{ all -> 0x012a }
        r8 = gwb.e(r1);	 Catch:{ all -> 0x012a }
        if (r8 != 0) goto L_0x0118;
    L_0x00cc:
        r8 = gwb.f(r1);	 Catch:{ all -> 0x012a }
        if (r8 != 0) goto L_0x0118;
    L_0x00d2:
        r8 = gwb.g(r1);	 Catch:{ all -> 0x012a }
        if (r8 != 0) goto L_0x0118;
    L_0x00d8:
        r8 = new java.io.ByteArrayOutputStream;	 Catch:{ all -> 0x012a }
        r8.<init>();	 Catch:{ all -> 0x012a }
        r9 = "text/plain";
        r9 = r9.equals(r1);	 Catch:{ all -> 0x012a }
    ...
    L_0x00ed:
        r9 = "text/html";
        r1 = r9.equals(r1);	 Catch:{ all -> 0x012a }
        if (r1 == 0) goto L_0x0137;
    L_0x00f5:
        r1 = 8;
        r1 = r5.getString(r1);	 Catch:{ all -> 0x012a }
        r7 = new aic;	 Catch:{ all -> 0x012a }
        if (r2 == 0) goto L_0x0131;
    L_0x00ff:
        r2 = r2.intValue();	 Catch:{ all -> 0x012a }
    L_0x0103:
        if (r1 == 0) goto L_0x0134;
    L_0x0105:
        r7.<init>(r2, r1);	 Catch:{ all -> 0x012a }
        r1 = r7.b();	 Catch:{ all -> 0x012a }
        r2 = 0;
        r7 = r1.length;	 Catch:{ all -> 0x012a }
        r8.write(r1, r2, r7);	 Catch:{ all -> 0x012a }
    L_0x0111:
        r1 = r8.toByteArray();	 Catch:{ all -> 0x012a }
        r6.a(r1);	 Catch:{ all -> 0x012a }
    L_0x0118:
        r1 = r4 + 1;
        r0[r4] = r6;	 Catch:{ all -> 0x012a }
        r4 = r1;
        goto L_0x0040;
    L_0x011f:
        r2 = r3;
    ...
    L_0x0134:
        ...
        goto L_0x0105;
    L_0x0137:
        r1 = r11.r;	 Catch:{ IOException -> 0x015f }
        r1 = r1.openInputStream(r7);	 Catch:{ IOException -> 0x015f }
        r2 = 256; // 0x100 float:3.59E-43 double:1.265E-321;
        r7 = new byte[r2];	 Catch:{ IOException -> 0x018b, all -> 0x0188 }
        r2 = r1.read(r7);	 Catch:{ IOException -> 0x018b, all -> 0x0188 }
    L_0x0145:
        if (r2 < 0) goto L_0x0150;
    L_0x0147:
        r9 = 0;
        r8.write(r7, r9, r2);	 Catch:{ IOException -> 0x018b, all -> 0x0188 }
        r2 = r1.read(r7);	 Catch:{ IOException -> 0x018b, all -> 0x0188 }
        goto L_0x0145;
    L_0x0150:
    ...
    L_0x0156:
        r1 = move-exception;
        r2 = "PduPersister";
        r7 = "Failed to close stream";
        android.util.Log.e(r2, r7, r1);	 Catch:{ all -> 0x012a }
        goto L_0x0111;
    L_0x015f:
        r0 = move-exception;
    L_0x0160:
        ...
        android.util.Log.e(r1, r2, r0);	 Catch:{ all -> 0x0170 }
        r5.close();	 Catch:{ all -> 0x0170 }
        r1 = new ahz;	 Catch:{ all -> 0x0170 }
        r1.<init>(r0);	 Catch:{ all -> 0x0170 }
    ...
    L_0x0177:
        ...
        android.util.Log.e(r2, r3, r1);	 Catch:{ all -> 0x012a }
        goto L_0x0176;
    L_0x0180:
    ...
    L_0x018b:
        ...
        goto L_0x0160;
        */
        throw new UnsupportedOperationException("Method not decompiled: aip.a(long):aio[]");
    }
            ...
            while (a.moveToNext()) {
                ...
                if (!TextUtils.isEmpty(string)) {
                    ...
                    switch (i) {
                        ...
                        case 130:
                        case 151:
                            aim.b(new aic(a.getInt(1), a(string)), i);
                            break;
                        case 137:
                            try {
                                aim.a(new aic(a.getInt(1), a(string)), i);
                                break;
                            } finally {
                                a.close();
                            }
    ...
    private void a(Cursor cursor, aim aim) {
        ...
        while (true) {
            ...
            if (string != null && string.length() > 0) {
                aim.a(new aic(cursor.getInt(g.get(keyAt)), a(string)), keyAt);
            }
        }
        size = i.size();
        while (true) {
    ...
    private void a(long j, int i, aic[] aicArr) {
        ...
        for (aic aic : aicArr) {
            contentValues.clear();
            contentValues.put("address", a(aic.b()));
    ...
    private static String a(aio aio) {
        return aio.g() == null ? null : a(aio.g());
    }
    ...
    public Uri a(aio aio, long j, Map<Uri, InputStream> map) {
        ...
        if (a != null) {
            ...
            j2 = aio.f();
            if (j2 != null) {
                contentValues.put("cd", a(j2));
            }
            j2 = aio.c();
            if (j2 != null) {
                contentValues.put("cid", a(j2));
            }
            j2 = aio.e();
            if (j2 != null) {
                contentValues.put("cl", a(j2));
            }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void a(aio r16, android.net.Uri r17, java.lang.String r18, java.util.Map<android.net.Uri, java.io.InputStream> r19) {
        /*
        r15 = this;
        r6 = 0;
        r5 = 0;
    ...
    L_0x00b8:
        ...
        throw r7;	 Catch:{ all -> 0x0074 }
    L_0x00c6:
        r8 = gwb.k(r18);	 Catch:{ FileNotFoundException -> 0x0066, IOException -> 0x00b8, all -> 0x0356 }
    ...
    L_0x0111:
        ...
        r0 = r18;
        r4 = aiy.a(r2, r0);	 Catch:{ FileNotFoundException -> 0x0066, IOException -> 0x00b8 }
    ...
    public Uri a(aid aid, Uri uri, boolean z, boolean z2, Map<Uri, InputStream> map, aiq aiq) {
        ...
        while (true) {
            ...
            if (c != null) {
                ...
                contentValues.put((String) m.valueAt(i), a(c.b()));
        ...
        while (true) {
            ...
            if (b2 != null) {
                contentValues.put((String) n.valueAt(i2), a(b2));
            }
            size = i2;
        }
        size = o.size();
