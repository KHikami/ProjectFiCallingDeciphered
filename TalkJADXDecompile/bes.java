...
final class bes extends jii {
    ...
    private static beq a(boolean z, Context context, int i) {
        ...
        if (!b.a(i)) {
            ...
            Cursor query = b(context, i).getReadableDatabase().query("client_callerid_settings", strArr, new StringBuilder(String.valueOf(valueOf).length() + 11).append(valueOf).append(gld.a(true)).toString(), null, null, null, null, null);
            try {
                switch (query.getCount()) {
                    ...
                    case wi.j /*1*/:
                        query.moveToFirst();
                        b.a(i, new beq(query.getLong(0), a(query)));
                        break;
                    default:
