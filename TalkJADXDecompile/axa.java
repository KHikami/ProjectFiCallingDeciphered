...
public final class axa {
    ...
    public static Bitmap b(ard ard, Bitmap bitmap, int i, int i2) {
        ...
        Bitmap a = ard.a(width, height, a(bitmap));
        a(bitmap, a);
    ...
    public static Bitmap c(ard ard, Bitmap bitmap, int i, int i2) {
        return (bitmap.getWidth() > i || bitmap.getHeight() > i2) ? b(ard, bitmap, i, i2) : bitmap;
    }

    public static void a(Bitmap bitmap, Bitmap bitmap2) {
        a(bitmap2, bitmap.hasAlpha());
    }
    ...
    public static Bitmap a(ard ard, Bitmap bitmap, int i) {
        ...
        Bitmap a = ard.a(Math.round(rectF.width()), Math.round(rectF.height()), a(bitmap));
