...
public final class ijn implements ite {
    ...
    public void a(itf itf) {
        ...
        if (this.l == null) {
            ...
            itf itf2 = this.l;
            a(itf2.o(), itf.o(), false, "accountName");
            a(itf2.a(), itf.a(), false, "sessionId");
            a(itf2.b(), itf.b(), false, "participantLogId");
            a(itf2.p(), itf.p(), false, "clientId");
            a(itf2.q(), itf.q(), false, "gcmRegistration");
            a(itf2.r(), itf.r(), false, "compressedLogFile");
            a(itf2.f(), itf.f(), true, "resolvedHangoutId");
            if (itf2.z() != null) {
