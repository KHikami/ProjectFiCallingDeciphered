...
final class dg extends ew implements Runnable {
            ...
            for (dj djVar = this.c; djVar != null; djVar = djVar.a) {
                switch (djVar.c) {
                    ...
                    case wi.l /*2*/:
                            ...
                            for (int i = 0; i < this.b.g.size(); i++) {
                                ...
                                if (drVar2 == null || drVar3.H == drVar2.H) {
                                    if (drVar3 == drVar2) {
                                        ...
                                        a((SparseArray) sparseArray, (SparseArray) sparseArray2, drVar3);
                                    }
                                }
                            }
                        }
                        ...
                        break;
                    case wi.z /*3*/:
                        a((SparseArray) sparseArray, (SparseArray) sparseArray2, djVar.d);
                        break;
                    case wi.h /*4*/:
                        a((SparseArray) sparseArray, (SparseArray) sparseArray2, djVar.d);
                        break;
    ...
    private dk a(SparseArray<dr> sparseArray, SparseArray<dr> sparseArray2, boolean z) {
        ...
        while (i2 < sparseArray.size()) {
            int i4;
            if (a(sparseArray.keyAt(i2), dkVar, z, sparseArray, sparseArray2)) {
                i4 = 1;
            } else {
                i4 = i3;
            }
        ...
        while (i < sparseArray2.size()) {
            ...
            if (sparseArray.get(i4) == null && a(i4, dkVar, z, sparseArray, sparseArray2)) {
                i3 = 1;
            }
            i++;
        }
    ...
    private static void a(dk dkVar, ArrayList<String> arrayList, ArrayList<String> arrayList2) {
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                a(dkVar.a, (String) arrayList.get(i), (String) arrayList2.get(i));
            }
        }
    }
