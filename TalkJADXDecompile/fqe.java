...
public final class fqe {
    ...
    public static List<fqd> a(Intent intent, int i, boolean z) {
        ...
        List<fqd> a = a(intent.getStringExtra("payload"), intent.getLongExtra("timestamp", 0), intent.getLongExtra("gcm_handle_timestamps", 0), glj.b() * 1000, i, z);
        if (!z || !gjk.b) {
            return a;
        }
        gjk.c();
        ...
        try {
            ...
            if (lnt.a.length > 0) {
                ...
                for (lwd lwd : lnt.a) {
                    ...
                    arrayList2.addAll(a(lwd, i2, i, a, z4, z2, gjn));
