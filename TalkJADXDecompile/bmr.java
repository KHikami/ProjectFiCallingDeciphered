...
public final class bmr extends SQLiteOpenHelper {
    ...
    private static final Map<Integer, bmr> d;
    ...
    L_0x0035:
        ...
        r0 = a(r1, r0);	 Catch:{ Exception -> 0x00fd }
        r1 = "Babel";
        r6 = 3;
        r1 = glk.a(r1, r6);	 Catch:{ Exception -> 0x00fd }
    ...
    L_0x0050:
        ...
        glk.a(r1, r6, r7);	 Catch:{ Exception -> 0x00fd }
    L_0x005a:
    ...
    L_0x0118:
        glk.d(r6, r1, r0);	 Catch:{ all -> 0x0130 }
        r0 = r5.edit();
        r1 = "last_database_upgrade_failure_state";
        r0 = r0.remove(r1);
        r0.commit();
    ...
    L_0x0167:
        ...
        glk.d(r0, r6, r1);	 Catch:{ all -> 0x0202 }
        r0 = r11.b;	 Catch:{ all -> 0x0202 }
        r6 = gmp.class;
        r0 = jyn.a(r0, r6);	 Catch:{ all -> 0x0202 }
        r0 = (gmp) r0;	 Catch:{ all -> 0x0202 }
    ...
    L_0x0211:
        ...
        r7 = fwy.MEMBERSHIP_CHANGE_DEPRECATED;	 Catch:{ Throwable -> 0x0167 }
        ...
        r7 = "_id=?";
        a(r12, r0, r1, r6, r7);	 Catch:{ Throwable -> 0x0167 }
        r0 = 2;
        r0 = new java.lang.String[r0];	 Catch:{ Throwable -> 0x0167 }
        r1 = 0;
        r6 = "_id";
    ...
    L_0x0536:
        ...
        r8 = 0;
        r9 = edq.PHONE;	 Catch:{ Throwable -> 0x0167 }
    ...
    L_0x05b2:
        ...
        r1 = fwx.UNKNOWN;	 Catch:{ Throwable -> 0x0167 }
    ...
    L_0x0665:
        ...
        r12.execSQL(r0);	 Catch:{ Throwable -> 0x0167 }
        r1 = dwz.a();	 Catch:{ Throwable -> 0x0167 }
    ...
    L_0x0786:
        ...
        r1 = 0;
        blo.a(r0, r1);	 Catch:{ Throwable -> 0x0167 }
        r0 = r5.edit();
    ...
    private String a(SQLiteDatabase sQLiteDatabase, Map<String, Object> map, boolean z) {
        ...
        if (z && obj != null && (obj instanceof List)) {
            ...
            for (Object obj2 : (List) obj2) {
                if (obj2 == null || !(obj2 instanceof fbw)) {
                    ...
                    fbw fbw = (fbw) obj2;
                    i = a(sQLiteDatabase, fbw.a, fbw.b, fbw.d, fbw.c, fbw.e);
                }
                if (i >= 0) {
        ...
        for (Object next : (List) obj2) {
            if (next instanceof String) {
                i = a(sQLiteDatabase, null, null, null, null, (String) next);
            } else if (next instanceof edo) {
                edo edo = (edo) next;
                i = a(sQLiteDatabase, edo.a, edo.b, null, null, null);
            } else {
                i = -1;
            }
            if (i >= 0) {
    ...
    private String a(SQLiteDatabase sQLiteDatabase, edo edo, Map<String, Object> map) {
        ...
        for (Object obj4 : list) {
            if (obj4 instanceof edo) {
                ...
                if (obj5 != null && (obj5 instanceof String)) {
                    int a = a(sQLiteDatabase, edo2.a, edo2.b, null, null, (String) obj5);
                    if (a >= 0) {
        ...
        if (edo != null && obj3 != null && (obj3 instanceof String) && list.size() == 1) {
            ...
            if ((obj4 instanceof edo) && edo.a((edo) obj4)) {
                int a2 = a(sQLiteDatabase, null, null, null, null, (String) obj3);
                if (a2 >= 0) {
                    stringBuilder = new StringBuilder();
    ...
    private void d(android.database.sqlite.SQLiteDatabase r17) {
        ...
        r9 = 0;
        r2 = "messages";
        r4 = "participant_keys IS NOT NULL";
        r5 = 0;
        r6 = 0;
        r7 = 0;
        r8 = 0;
    ...
    L_0x0073:
        ...
        r4 = "participant_row_id=? AND conversation_id=?";
        r1 = 2;
