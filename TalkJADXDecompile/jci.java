...
public class jci implements jck {
    ...
    public boolean a(String str) {
        ...
        if (jdi != null) {
            ...
            return this.e.b.contains(a(this.b, g));
        }
    }
    ...
    public String a(String str, String str2) {
        ...
        return this.e.b.getString(a(this.b, g), str2);
    }
    ...
    public Set<String> a(String str, Set<String> set) {
        ...
        return this.e.b.getStringSet(a(this.b, g), null);
    }
    ...
    public boolean a(String str, boolean z) {
        ...
        return this.e.b.getBoolean(a(this.b, g), z);
    }
    ...
    public int a(String str, int i) {
        ...
        return this.e.b.getInt(a(this.b, g), i);
    }
    ...
    public long a(String str, long j) {
        ...
        return this.e.b.getLong(a(this.b, g), j);
    }
    ...
    public void a(int i, Editor editor) {
        for (String str : this.c.keySet()) {
            ((jdi) this.c.get(str)).a(editor, a(i, str));
        }
    }
