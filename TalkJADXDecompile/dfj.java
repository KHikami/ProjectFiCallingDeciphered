...
public final class dfj implements dey {
    private static final iic b;
    private static final iic c;
    private static final anw<iic> d;
    ...
    static {
        b = new iic().b().d();
        c = new iic(b).a();
        d = anw.a("com.google.android.apps.hangouts.glide.impl.FifeUrlOptions", b);
    }
