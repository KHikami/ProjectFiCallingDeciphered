    ...
    public void a(blo blo, fhc fhc) {
        ...
        if (this.i) {
            ...
            try {
                ...
                RealTimeChatService.a(g.g(), (boolean) g, fjl.NO_DELAY, flt.CLEAR_CACHE_RESYNC);
                if (g.m()) {
            ...
            if (!this.j || a.size() <= gwb.a(blo.f(), "babel_separate_gcr_threshold", 5)) {
                        ...
                        if (blf.a(blo.g(), ess.b)) {
                            ...
                            if (ess.g != 0) {
                                ...
                                if (!this.j) {
                                    ...
                                    if (!gwb.a(blo.f(), "babel_crashifmissedpush", (boolean) g) || size <= 0 || this.b == null || !((evs) this.b).n()) {
                                        if (blf.a) {
                                        ...
                                        if (ess.b != null) {
                                            if (blf.a(blo, ess.b, ess.h, null, fhc, null, g)) {
                                                obj = 1;
                                            }
                                            if (!ess.b.m()) {
                                ...
                                if (ess.b == null) {
                                    if (!blo.r(ess.a)) {
                                        ...
                                        if (!this.j || r4 == null) {
                                            ...
                                            fhc.a(new euw(ess.a, true, true, g, null, 0, str, 0, null));
                                            c.a(str);
                                        } else {
                                            obj2 = obj3;
                                        }
                ...
                fhc.a(new evt(5, (boolean) g, str));
                fhc.a(new evt(6, (boolean) g, null));
                blo.t();
                blo.p();
                bkq.b(blo.f(), blo.g().g(), "last_successful_sync_time", 0);
                obj2 = 1;
