...
public abstract class hud<T> {
    ...
    private final void a(ArrayList<T> arrayList, String str) {
        ...
        while (i < length) {
            ...
            int a = a(str, this.c, i, indexOf);
            int a2 = a(str, this.c, a + 1, indexOf);
            if (a >= 0 && a2 >= 0) {
    ...
    private final void b(ArrayList<T> arrayList, String str) {
        for (String split : TextUtils.split(str, this.f)) {
            ...
            if (split2.length < 13) {
                ...
                a(arrayList, split2[0], split2[1], split2[2], a(split2[3]), a(split2[4]), a(split2[5]), a(split2[6]), a(split2[7]), hvx.a(split2[8]), hvx.a(split2[9]), hvx.a(split2[10]), hvx.a(split2[11]), hvx.a(split2[12]));
            }
        }
    }
