...
public final class ajd {
    ...
    L_0x000a:
        ...
        r2 = ajf.a();	 Catch:{ URISyntaxException -> 0x023c, IllegalStateException -> 0x0239, IllegalArgumentException -> 0x0236, SocketException -> 0x0208, Exception -> 0x0213, all -> 0x021e }
        ...
        r0 = r22;
        r3 = ajg.a(r2, r13, r0);	 Catch:{ URISyntaxException -> 0x023c, IllegalStateException -> 0x0239, IllegalArgumentException -> 0x0236, SocketException -> 0x0208, Exception -> 0x0213, all -> 0x021e }
        ...
        r6 = ajf.a();	 Catch:{ URISyntaxException -> 0x023c, IllegalStateException -> 0x0239, IllegalArgumentException -> 0x0236, SocketException -> 0x0208, Exception -> 0x0213, all -> 0x021e }
    ...
    L_0x0078:
        ...
        r2 = ajf.a();	 Catch:{ URISyntaxException -> 0x01b8, IllegalStateException -> 0x01e7, IllegalArgumentException -> 0x01f7, SocketException -> 0x0234, Exception -> 0x0232 }
        ...
        r4 = ajf.a();	 Catch:{ URISyntaxException -> 0x01b8, IllegalStateException -> 0x01e7, IllegalArgumentException -> 0x01f7, SocketException -> 0x0234, Exception -> 0x0232 }
    ...
    L_0x00b8:
        ...
        r7 = a(r7);	 Catch:{ URISyntaxException -> 0x01b8, IllegalStateException -> 0x01e7, IllegalArgumentException -> 0x01f7, SocketException -> 0x0234, Exception -> 0x0232 }
