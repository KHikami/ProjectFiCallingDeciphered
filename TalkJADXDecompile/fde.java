...
public class fde implements jcd, jnh {//babel account?
    ...
    public void a(int i) {
        ...
        if (a.c("logged_out")) {
            ...
            if (a.c("is_sms_account") && i()) {
                b(t());
            }
        } else if (!a.c("sms_only")) {
            RealTimeChatService.a(i);
        }
        a(jcf, gwb.a(Integer.valueOf(i)));
    }
    ...
    public static bko a(Context context) {
        ...
        return (l == null || bkq.d(context, l.g())) ? t() : l;
    }
    ...
    static bko l() {
        ...
        ba.b(z);
        if (a.size() == 1) {
            return e(gwb.a((Integer) a.get(0), -1));
        }
        return null;
    }

    private static bko t() {
        return e(((fzw) jyn.a(gwb.H(), fzw.class)).a());
    }

    static void a(Context context, boolean z) {
        boolean z2 = true;
        if (glq.c(context)) {
            jci b = ((jcf) jyn.a(gwb.H(), jcf.class)).b(t().g()).b("logged_in", z);
    ...
    public static void b(bko bko) {
        ...
        iil.a("Expected condition to be true", i());
        a(H, a);
        if (glk.a("Babel", 3)) {
            String str = "Babel";
    ...
    public static void a(bko bko, Exception exception) {
        ...
        String valueOf = String.valueOf(k(bko.g()).a());
    ...
    private static fdh k(int i) {
        ...
        if (jcf.c(i)) {
            ...
            return fdh == null ? b(jcf.a(i).b("account_name")) : fdh;
        } else {
    ...
    public static void a(PrintWriter printWriter) {
        ...
        for (fdh fdh : b.values()) {
            ...
            if (f == null) {
                str = "?, ?, ?, ";
                valueOf = String.valueOf(l(fdh.g()));
