...
final class jpq {
    ...
    static {
        ...
        e = "sp".toCharArray();
        f = "bp".toCharArray();
        g = ".googleusercontent.com/".toCharArray();
        h = "www.google.com/visualsearch/lh/".toCharArray();
        i = ".google.com/".toCharArray();
        j = ".blogger.com/".toCharArray();
        k = ".bp.blogspot.com/".toCharArray();
        l = ".ggpht.com/".toCharArray();
        m = "image".toCharArray();
        n = "%3D".toCharArray();
        o = "%3d".toCharArray();
        r0 = new char[5][];
    ...
    synchronized String a(String str, int i, int i2, int i3, int i4, int i5, int i6, RectF rectF, int i7, int i8) {
        ...
        if (this.B) {
            ...
            if (!((i & 1024) == 0 || rectF == null)) {
                ...
                stringBuilder2.append(a(rectF.left));
                stringBuilder2.append(a(rectF.top));
                stringBuilder2.append(a(rectF.right));
                stringBuilder2.append(a(rectF.bottom));
                stringBuilder2.append('-');
            }
            if (i8 >= 0) {
