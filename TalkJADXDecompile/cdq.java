...
final class cdq {
    private static final mjq<Class<? extends bxs>> a;
    ...
    private void a(ContextMenu contextMenu, MessageListItemView messageListItemView) {
        ...
        if (!TextUtils.isEmpty(f)) {
            ...
            for (String str : a((URLSpan[]) spannableString.getSpans(0, spannableString.length(), URLSpan.class))) {
                String str2;
                String substring;
                boolean z;
                Object obj;
