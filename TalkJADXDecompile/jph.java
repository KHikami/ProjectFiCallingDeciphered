...
public final class jph extends jkj implements jts, jtt {
    ...
    private String a(jpf jpf, int i, int i2, int i3, int i4, int i5) {
        ...
        a(a, jpf.b()).append(File.separatorChar).append(i2).append(',').append(i3).append(',').append(i4).append(',').append(i5).append(',');
        a(a, i);
        a.append(',');
        return kdq.a(a);
    }
                                        ...
                                        if (d4 >= d2 && d4 <= d3 && parseInt3 == this.T) {
                                            if (str == null) {
                                                ...
                                                if (!(this.V == jpj.d && this.W == jpj.e && (parseInt != jpj.d || parseInt2 != jpj.e))) {
                                                    if (!a(this.V, parseInt, jpj.d)) {
                                                        if (!a(this.W, parseInt2, jpj.e) && ((jpj.d == 0 || this.V == 0 || parseInt != 0) && (jpj.e == 0 || this.W == 0 || parseInt2 != 0))) {
                                                            this.V = parseInt;
                                                            this.W = parseInt2;
                                                            this.X = parseInt3;
                                                            this.Y = parseInt4;
    ...
    private boolean a(jpj jpj, Object obj) {
        if (jpj.a.h() || !a(jpj) || jpj.c == -1 || (jpj.i & 4096) != 0) {
            return false;
        }
        if (this.X == 0) {
            if (this.Y > this.U) {
