...
public final class jld implements jin {
    ...
    private final int h;
    private int i;
    private final Map<jla, int[]> j;

    static {
        b = (int) Math.round(Math.sqrt(16.0d));
        c = new kae("debug.social.bitmap_pool", (byte) 0);
        d = new String[]{"put", "evict", "hit", "inexact hit", "miss"};
    }
