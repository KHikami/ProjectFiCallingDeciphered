...
public final class bir implements bhx, biv {
    ...
    private bir(android.content.Context r3, java.util.Map<java.lang.String, bit> r4, com.google.android.apps.hangouts.concurrent.impl.ConcurrentService r5, bip r6, android.os.PowerManager.WakeLock r7) {
        /*
        r2 = this;
        r2.<init>();
        ...
        r2.b = r0;
        r2.c = r3;
        r0 = r4 instanceof mjx;
        if (r0 == 0) goto L_0x0026;
    L_0x0010:
        r0 = r4 instanceof mkz;
        if (r0 != 0) goto L_0x0026;
    L_0x0014:
        r0 = r4;
        r0 = (mjx) r0;
