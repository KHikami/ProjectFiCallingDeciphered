...
public final class PackageStatsCapture {
    ...
    static {
        ...
        r0[0] = new izo("getPackageSizeInfo", new Class[]{String.class, IPackageStatsObserver.class});
        r0[1] = new izp("getPackageSizeInfo", new Class[]{String.class, Integer.TYPE, IPackageStatsObserver.class});
        r0[2] = new izq("getPackageSizeInfoAsUser", new Class[]{String.class, Integer.TYPE, IPackageStatsObserver.class});
