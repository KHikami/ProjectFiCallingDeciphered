...
public final class htn implements OnClickListener {
    ...
    public void onClick(View view) {
        if (!(this.a.h == null || this.a.a == null || this.a.a.size() < 2)) {
            a aVar = this.a.h;
            this.a.a.get(1);
            if (aVar.m()) {
                return;
        ...
        if (selectedAccountNavigationView.a != null && selectedAccountNavigationView.a.size() != 0) {
            ...
            View view2 = selectedAccountNavigationView.d.t;
            View view3 = selectedAccountNavigationView.d.x;
            view2.bringToFront();
            hwn hwn = (hwn) selectedAccountNavigationView.a.get(1);
            ...
            View view4 = selectedAccountNavigationView.d.E;
            ImageView imageView = selectedAccountNavigationView.d.H;
            if (imageView != null) {
            ...
            selectedAccountNavigationView.b = (hwn) selectedAccountNavigationView.a.get(1);
            selectedAccountNavigationView.a.add(1, hwn2);
            selectedAccountNavigationView.a.remove(2);
