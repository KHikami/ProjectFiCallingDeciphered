...
public final class jpo {
    ...
    public static String a(String str, int i, RectF rectF) {
        String a = a(str, i, 0, 0, 0, -1, -1, rectF, jpp.a, -1);
        if (a == null) {
            return jpr.a(-1, str);
        }
        return a;
    ...
    public static String a(String str, int i, int i2, RectF rectF) {
        String a = a(str, i, i2, 0, 0, -1, -1, rectF, jpp.a, -1);
        if (a == null) {
            return jpr.a(i2, str);
        }
        return a;
    ...
    public static String a(String str, int i, int i2, int i3, int i4, int i5, int i6) {
        String a = a(str, i, 0, i2, i3, i5, i6, null, jpp.a, i4);
        if (a != null) {
            return a;
        }
        if (i2 == 0 && i3 == 0) {
    ...
    public static String a(String str, int i, int i2, int i3, int i4, int i5, RectF rectF) {
        String a = a(str, i, 0, i2, i3, i4, i5, rectF, jpp.a, -1);
        if (a != null) {
            return a;
        }
        if (i2 == 0 && i3 == 0) {
    ...
    public static String a(RectF rectF, int i) {
        ...
        String valueOf = String.valueOf(a(rectF.left));
        String valueOf2 = String.valueOf(a(rectF.top));
        String valueOf3 = String.valueOf(a(rectF.right));
        String valueOf4 = String.valueOf(a(rectF.bottom));
