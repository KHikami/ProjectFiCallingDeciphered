...
public final class avy implements aob<Bitmap> {
    ...
    public static final anw<CompressFormat> b;

    static {
        a = anw.a("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", Integer.valueOf(90));
        b = new anw("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat", null, anw.a);
    }
