    ...
    public static void a(PrintWriter printWriter) {
        synchronized (e) {
            ...
            for (int i = 0; i < d.a(); i++) {
                ...
                objArr[1] = Integer.valueOf(a(fss.c, fss.b));
                objArr[2] = Integer.valueOf(a(fss.d, fss.b));
                objArr[3] = Integer.valueOf(a(fss.e, fss.d));
                objArr[4] = Integer.valueOf(a(fss.f, fss.e));
                objArr[5] = Integer.valueOf(a(fss.f, fss.b));
                objArr[6] = fss.g;
