...
public final class iys {
    static final Iterable<String> a;
    static final Iterable<Integer> b;
    private final File c;

    static {
        a = Collections.unmodifiableList(Arrays.asList(new String[]{"boolean", "boolean[]", "boolean[][]", "byte", "byte[]", "byte[][]", "byte[][][]", "char", "char[]", "char[][]", "short", "short[]", "short[][]", "int", "int[]", "int[][]", "int[][][]", "long", "long[]", "long[][]", "float", "float[]", "float[][]", "double", "double[]", "double[][]", "java.lang.Class", "java.lang.Class[]", "java.lang.Class[][]", "java.lang.Byte", "java.lang.Byte[]", "java.lang.Character", "java.lang.Character[]", "java.lang.Boolean", "java.lang.Boolean[]", "java.lang.Short", "java.lang.Short[]", "java.lang.Integer", "java.lang.Integer[]", "java.lang.Long", "java.lang.Long[]", "java.lang.Float", "java.lang.Float[]", "java.lang.Double", "java.lang.Double[]", "java.lang.String", "java.lang.String[]", "java.lang.String[][]", "java.lang.String[][][]"}));
        b = Collections.unmodifiableList(Arrays.asList(new Integer[]{Integer.valueOf(139), Integer.valueOf(138), Integer.valueOf(137), Integer.valueOf(255), Integer.valueOf(144)}));
    }
    ...
    private void a(iyz iyz, izd<iyw> izd_iyw, Deque<iyw> deque) {
        while (!deque.isEmpty()) {
            ...
            for (int i = 0; i < a; i++) {
                ...
                if (iyw2 != null && iyw2.c == null && (iyw2.d & 1) == 0 && !a(iyw2)) {
                    iyw2.c = iyw;
                    deque.addLast(iyw2);
                }
            }
