...
public final class etu implements esn {
    private static final etx[] c;
    public final int a;
    public final String b;
    private final EnumMap<etx, etv> d;
    ...
    private boolean b(etx etx, Object obj, long j) {
        ...
        if (etv == null) {
            ...
            if (etx == etx.LAST_SEEN && etv.b != null && obj != null && !a((Long) etv.b, (Long) obj, j)) {
                return false;
            }
            etv.b = obj;
        }
    ...
    public int b(int i, long j) {
        ...
        while (i2 < length) {
            int i4;
            etx etx = etxArr[i2];
            if (etx.a(i) && a(etx, (etv) this.d.get(etx), j)) {
                i4 = etx.l | i3;
            } else {
                i4 = i3;
            }
