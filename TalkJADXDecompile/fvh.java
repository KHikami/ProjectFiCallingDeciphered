...
public final class fvh extends jzn implements jwg {
    ...
    public void a() {
        ...
        jvv = a(this.context, bc.ac, intent.getStringExtra("sound_key"), intent.getIntExtra("sound_type", 0), this.a);
        b.c(jvv);
        jvv.e(stringExtra);
        String stringExtra2 = intent.getStringExtra("vibrate_key");
        jwi a = a(this.context, this.a.a(), bc.kv, stringExtra2, this.a.c().a(stringExtra2, true));
        b.c(a);
        a.e(stringExtra);
    }
