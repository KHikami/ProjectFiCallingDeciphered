...
public final class moy {
    static final moy a;
    private static final Comparator<Object> b;
    private static final SortedSet<Object> c;
    ...
    static {
        b = new moz();
        c = Collections.unmodifiableSortedSet(new TreeSet());
        a = new moy(Collections.unmodifiableSortedMap(new TreeMap()));
    }
            ...
            if (sortedMap.isEmpty()) {
                ...
                for (Entry entry : sortedMap.entrySet()) {
                    ...
                    if (!sortedSet.isEmpty()) {
                        stringBuilder.append(':');
                        if (sortedSet.size() == 1) {
                            stringBuilder.append(a(sortedSet.iterator().next()));
                        } else {
                            stringBuilder.append('[');
                            for (Object a : sortedSet) {
                                stringBuilder.append(a(a)).append(',');
                            }
