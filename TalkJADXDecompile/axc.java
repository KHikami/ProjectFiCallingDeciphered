...
public final class axc implements aoa<ParcelFileDescriptor, Bitmap> {
    public static final anw<Long> a;
    public static final anw<Integer> b;
    private static final axf c;
    private final ard d;
    private final axf e;
    ...
    static {
        a = anw.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", Long.valueOf(-1), new axd());
        b = anw.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption", null, new axe());
        c = new axf();
    }
