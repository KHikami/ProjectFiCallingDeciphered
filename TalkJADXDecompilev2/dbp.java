...
public class dbp extends jzn implements pc {
    ...
    final Map<String, Integer> b = new ky();
    dbx c;
    ViewPager d;
    dca e;
    int f = -1;
    public final OnClickListener g = new dbq(this);
    final Runnable h = new dbt(this);
