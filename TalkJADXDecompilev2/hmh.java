...
final class hmh implements hmf {
    ...
    public gyj a(gyj gyj, gyj gyj2, Bundle bundle) {
    ...
    public hmc a() {
        ...
        try {
            ...
            obtain2.readException();
            hmc a = hmd.a(obtain2.readStrongBinder());
            return a;
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public void a(gyj gyj, StreetViewPanoramaOptions streetViewPanoramaOptions, Bundle bundle) {
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
