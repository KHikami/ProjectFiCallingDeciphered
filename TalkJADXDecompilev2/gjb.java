...
public final class gjb extends giz {
    ...
    private Bitmap b(int i, int i2, gja gja) {
        ...
        if (c != 0) {
            synchronized (this.g) {
                ...
                if (gjc == null || gjc.a <= 0) {
                    if (b) {
                        str2 = this.c;
                        valueOf = String.valueOf(gjb.a(c));
                    ...
                    if (b) {
                        valueOf = this.c;
                        String valueOf2 = String.valueOf(gjb.a(c));
                        int i4 = gjc.a;
        ...
        if (b) {
            valueOf = this.c;
            String valueOf4 = String.valueOf(gjb.a(c));
    ...
    public void a(Bitmap bitmap) {
        ...
        int c = gjb.c(bitmap.getWidth(), bitmap.getHeight());
        ...
        synchronized (this.g) {
            ...
            if (gjc.a < gjc.b.length) {
                ...
                if (b) {
                    str = this.c;
                    String valueOf3 = String.valueOf(gjb.a(c));
    ...
    public void a() {
        synchronized (this.g) {
            for (int i = 0; i < this.f.size(); i++) {
                gjc gjc = (gjc) this.f.valueAt(i);
                for (int i2 = 0; i2 < gjc.a; i2++) {
                    c(gjc.b[i2]);
                    gjc.b[i2] = null;
                }
                gjc.a = 0;
    ...
    boolean b(Bitmap bitmap) {
        ...
        gjc gjc = (gjc) this.f.get(gjb.c(bitmap.getWidth(), bitmap.getHeight()));
        if (gjc == null) {
            return false;
        }
