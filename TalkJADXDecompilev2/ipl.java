...
public final class ipl implements ioq {
    private static final int[] a = new int[]{100, 103, 106, 109, 112};
    private static final int[] b = new int[]{101, 104, 107, 110, 113};
    private static final int[] c = new int[]{102, 105, 108, 111, 114};
    private final ioq d;
    private final iir e;
    private final ipn f;
