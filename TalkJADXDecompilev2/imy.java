...
public final class imy {
    ...
    private final inb e = new inb(this);
                        ...
                        for (nzf nzf2 : ijf.b().values()) {
                            if (nzf2.c.equals("2") && nzf2.b.equals(a.b)) {
                                ...
                                if (nzf.g != null) {
                                    ...
                                    } else if (!(nzf.g.a.intValue() == 2 && nzf.g.c != null && nzf.g.c.length == 1 && imy.a(nzf.g.c[0].a.floatValue(), 0.0f) && imy.a(nzf.g.c[0].b.floatValue(), 0.0f) && imy.a(nzf.g.c[0].c.floatValue(), 1.0f) && imy.a(nzf.g.c[0].d.floatValue(), 1.0f))) {
                                        z = true;
                                    }
                                    z = false;
                                }
