...
public final class kfr implements Serializable {
    ...
    public String a() {
        ...
        kfr.a(stringBuilder, gregorianCalendar.get(1), 4);
        stringBuilder.append('-');
        kfr.a(stringBuilder, gregorianCalendar.get(2) + 1, 2);
        stringBuilder.append('-');
        kfr.a(stringBuilder, gregorianCalendar.get(5), 2);
        if (!this.d) {
            stringBuilder.append('T');
            kfr.a(stringBuilder, gregorianCalendar.get(11), 2);
            stringBuilder.append(':');
            kfr.a(stringBuilder, gregorianCalendar.get(12), 2);
            stringBuilder.append(':');
            kfr.a(stringBuilder, gregorianCalendar.get(13), 2);
            if (gregorianCalendar.isSet(14)) {
                stringBuilder.append('.');
                kfr.a(stringBuilder, gregorianCalendar.get(14), 3);
            }
            if (this.e == 0) {
                ...
                int i2 = i / 60;
                i %= 60;
                kfr.a(stringBuilder, i2, 2);
                stringBuilder.append(':');
                kfr.a(stringBuilder, i, 2);
            }
        }
