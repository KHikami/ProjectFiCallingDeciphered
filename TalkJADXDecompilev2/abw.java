...
public final class abw extends afi {
    ArrayList<ArrayList<aer>> a = new ArrayList();
    ArrayList<ArrayList<acg>> b = new ArrayList();
    ArrayList<ArrayList<acf>> c = new ArrayList();
    ArrayList<aer> d = new ArrayList();
    ArrayList<aer> e = new ArrayList();
    ArrayList<aer> f = new ArrayList();
    ArrayList<aer> g = new ArrayList();
    private ArrayList<aer> i = new ArrayList();
    private ArrayList<aer> j = new ArrayList();
    private ArrayList<acg> k = new ArrayList();
    private ArrayList<acf> l = new ArrayList();
