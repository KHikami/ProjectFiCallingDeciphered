...
final class dkt extends fip implements fqy {
    ...
    private final did c;
    private final Map<edk, bke> d = new HashMap();
    private final Map<bke, edk> e = new HashMap();
    private final Map<iqo, bke> f = new HashMap();
    private final Map<bke, iqo> g = new HashMap();
    private final ArrayList<edk> h = new ArrayList();
    private final Map<Integer, String> i = new HashMap();
    private final Map<String, Integer> j = new HashMap();
    private final ArrayList<dii> k = new ArrayList();
    private final edk l;
