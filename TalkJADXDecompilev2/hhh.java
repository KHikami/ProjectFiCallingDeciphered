...
public final class hhh {
    public static final hhq a = new hhj();
    public static final hhq b = new hhk();
    public static final hhq c = new hhl();
    public static final hhq d = new hhm();
    public static final hhq e = new hhn();
    private static hht f;
    private static final hhr g = new hhi();
    ...
    public static hhh a(Context context, hhq hhq, String str) {
        ...
        if (a.c == 0 || ((a.c == -1 && a.a == 0) || (a.c == 1 && a.b == 0))) {
            ...
            return hhh.b(context, str);
        } else {
            if (a.c == 1) {
                try {
                    return hhh.a(context, str, a.b);
                } catch (Throwable e) {
