...
public final class oik {
    ...
    public static oii a(InputStream inputStream, Integer num, Integer num2, boolean z, boolean z2, boolean z3, float f) {
        ...
        try {
            ...
            xMLReader.parse(new InputSource(oil.a()));
            oir.a = oin.a;
            ...
            oii oii = new oii(picture, oir.o);
            if (!Float.isInfinite(oir.p.top)) {
                oii.a(oir.p);
            }
            return oii;
        } catch (Throwable e) {
    ...
    static oip a(String str, Attributes attributes) {
        int length = attributes.getLength();
        for (int i = 0; i < length; i++) {
            if (attributes.getLocalName(i).equals(str)) {
                return oik.a(attributes.getValue(i));
            }
        }
        return null;
    }

    static String b(String str, Attributes attributes) {
        int length = attributes.getLength();
        for (int i = 0; i < length; i++) {
            if (attributes.getLocalName(i).equals(str)) {
