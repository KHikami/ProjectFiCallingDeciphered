    ...
    private boolean d(int i) {
        ...
        if (i3 > this.b.length) {
            if (this.c) {
                ...
                String.format("Increasing buffer length from %d to %d. Bad buffer size chosen, or advanceTo() not called.", new Object[]{Integer.valueOf(this.b.length), Integer.valueOf(ahr.e(i3))});
