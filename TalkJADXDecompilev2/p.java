...
public class p extends acv {
    ...
    public p(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f = obtainStyledAttributes.getInt(o.V, this.f);
        Drawable drawable = obtainStyledAttributes.getDrawable(o.U);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.a = obtainStyledAttributes.getBoolean(o.W, true);
