...
class fnj implements bhf, bhj, bhm {
    private static final int a = ((int) TimeUnit.MILLISECONDS.convert(1, TimeUnit.MINUTES));
    private static final int b = ((int) TimeUnit.MILLISECONDS.convert(1, TimeUnit.HOURS));
    private static final int c = ((int) TimeUnit.MILLISECONDS.convert(1, TimeUnit.SECONDS));
    private final int d;
    private final bhr e = new bhs().a((long) c).b((long) a).c((long) b).a();
