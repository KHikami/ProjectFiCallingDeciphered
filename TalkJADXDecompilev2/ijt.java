...
public final class ijt implements ilp {
    ...
    private final ilr A;
    private final Runnable C = new iju(this);
    ...
    private final Map<Integer, irg> x = new HashMap();
    private final irg y = new irg("Encode");
    ...
    boolean a(itf itf) {
        ...
        switch (this.A.a()) {
            case 0:
                ijt.a("We're not yet signed in; signing in and postponing initiation until done", new Object[0]);
                b(itf);
                this.c.a(true);
                break;
            case 1:
                ijt.a("Sign-in in progress. Postponing initiation until done", new Object[0]);
                this.c.a(true);
                break;
            case 2:
                h();
    ...
    private void h() {
        ...
        ijt.a(valueOf.length() != 0 ? str.concat(valueOf) : new String(str), new Object[0]);
        valueOf = h.f();
        this.c.a(valueOf);
        this.a.a(h, valueOf);
    }
    ...
    private void i() {
        int i = 0;
        ijt.a("CallManager.finishCall", new Object[0]);
        gwb.b(this.C);
        gwb.aJ();
        ijt.a("CallManager.endCallAndSignOut", new Object[0]);
        if (this.A.a() == 0) {
    ...
    public void d(boolean z) {
        ijt.a("handleSignedInStateUpdate: signedIn=" + z, new Object[0]);
        gwb.aJ();
    ...
    public void b(int i, String str) {
        ...
        if (ijt.a(this.c)) {
            this.c.a(i, str);
            ijt.a("CallManager.handleCallEnd - finishing call", new Object[0]);
            i();
            return;
        }
    ...
    public void a(String str, int i, int i2, String str2, String str3, String str4, byte[] bArr) {
        ...
        Object obj;
        if (itx.a(3)) {
            ijt.a("handleEndpointEvent: participantId=%s eventType=%s, args=%d, %s, %s, %s, participantProto? %b", str, ilq.a(i), Integer.valueOf(i2), str2, str3, str4, bArr);
        }
        if (ijt.a(this.c)) {
            iqo b = this.c.b(str);
            if (i == 0 || i == 1) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (gwb.a(lym2.n) == 5) {
                                    ...
                                    z = z2;
                                    iqu = new iqs(str, str3, str5, i3, str2, z2, z);
                                }
                                if (z2) {
                                    this.c.a((iqs) iqu);
                                } else {
                                ...
                                if (i == 0) {
                                    ...
                                    if (lym2 != null) {
                                        ijt.a("Updating privileges from proto", new Object[0]);
                                        for (int i4 : lym2.r) {
                                            switch (i4) {
                                                case 3:
                                                    iqu.c(true);
                                    ...
                                    ijt.a("Fallback to legacy privileges", new Object[0]);
                                    iqu.c(true);
                                }
                                b = iqu;
                                obj = iqq;
        ...
        ijt.a("Got endpoint event, but there's no current call. Ignore.", new Object[0]);
    }
