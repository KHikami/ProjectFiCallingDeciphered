...
public class ecw extends ebz {
    ...
    static void a(android.content.Context r6, int r7, defpackage.gjj r8) {
        /*
        r0 = 0;
    ...
    L_0x0011:
        r1 = c;
        monitor-enter(r1);
        r2 = defpackage.ecw.a(r6, r7);	 Catch:{ all -> 0x0065 }
    ...
    L_0x0032:
        r0 = defpackage.ecm.a(r6, r7, r0);	 Catch:{ all -> 0x0065 }
        r4 = defpackage.gw.a(r6);	 Catch:{ all -> 0x0065 }
        r5 = 0;
        defpackage.ecm.a(r0, r5);	 Catch:{ all -> 0x0065 }
        r5 = 0;
    ...
    L_0x0065:
        ...
        throw r0;
    L_0x0068:
        r0 = defpackage.jcf.class;
        r0 = defpackage.jyn.a(r6, r0);	 Catch:{ jcj -> 0x00b9 }
        r0 = (defpackage.jcf) r0;	 Catch:{ jcj -> 0x00b9 }
    ...
    protected ecw(Context context, int i, eap eap, boolean z) {
        ...
        if (ear.c) {
            this.f = this.h;
            this.e = ebs.s;
            this.h = c(ecw.a(ebs), ebs.b, this.j, this.k);
            this.g = ear.f;
        } else {
            ...
            if (size == 1) {
                ...
                for (int size3 = list.size() - 1; size3 >= 0; size3--) {
                    ...
                    if (!TextUtils.isEmpty(charSequence3) || !TextUtils.isEmpty(this.j)) {
                        CharSequence c;
                        if (ear.c) {
                            c = c(ecw.a(r1), charSequence3, this.j, this.k);
                        } else {
