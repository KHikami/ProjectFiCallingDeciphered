...
final class ccu extends AsyncTask<Void, Void, Void> {
    ...
    private final List<ArrayList<ky<String, String>>> c = new ArrayList();
    ...
    private void a(String str, dak dak, blo blo) {
        ...
        for (dap dap : dak.f()) {
            ...
            ccu.a(arrayList, str3, String.format(locale, str4, objArr));
        }
        for (dan dan : dak.g()) {
            ccu.a(arrayList, "email", dan.a);
        }
        ccu.a(arrayList, "qualifiedId", dak.b());
