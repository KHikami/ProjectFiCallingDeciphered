...
public final class dzs implements dzx {
    ...
    L_0x009b:
        ...
        r4 = defpackage.glj.b();	 Catch:{ all -> 0x0096 }
    ...
    L_0x000a:
        return;
    L_0x000b:
        r0 = a;	 Catch:{ all -> 0x0061 }
        if (r0 == 0) goto L_0x003f;
    L_0x000f:
        r0 = r5.b;	 Catch:{ all -> 0x0061 }
        r2 = r5.c;	 Catch:{ all -> 0x0061 }
        r2 = r2.size();	 Catch:{ all -> 0x0061 }
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0061 }
        r4 = java.lang.String.valueOf(r0);	 Catch:{ all -> 0x0061 }
        r4 = r4.length();	 Catch:{ all -> 0x0061 }
        r4 = r4 + 29;
        r3.<init>(r4);	 Catch:{ all -> 0x0061 }
        r4 = "resuming queue ";
        r3 = r3.append(r4);	 Catch:{ all -> 0x0061 }
        r0 = r3.append(r0);	 Catch:{ all -> 0x0061 }
        r3 = " [";
        r0 = r0.append(r3);	 Catch:{ all -> 0x0061 }
        r0 = r0.append(r2);	 Catch:{ all -> 0x0061 }
        r2 = "]";
        r0.append(r2);	 Catch:{ all -> 0x0061 }
    L_0x003f:
        r0 = 0;
        r5.h = r0;	 Catch:{ all -> 0x0061 }
        r0 = r5.f;	 Catch:{ all -> 0x0061 }
        if (r0 == 0) goto L_0x0064;
    L_0x0046:
        r2 = r0.isDone();	 Catch:{ all -> 0x0061 }
        if (r2 != 0) goto L_0x0064;
    L_0x004c:
        r2 = r0.isCancelled();	 Catch:{ all -> 0x0061 }
        if (r2 != 0) goto L_0x0064;
    L_0x0052:
        r2 = 0;
        r0 = r0.cancel(r2);	 Catch:{ all -> 0x0061 }
    L_0x0057:
        if (r0 == 0) goto L_0x005f;
    L_0x0059:
        r0 = 0;
        r5.f = r0;	 Catch:{ all -> 0x0061 }
        r5.f();	 Catch:{ all -> 0x0061 }
    L_0x005f:
        monitor-exit(r1);	 Catch:{ all -> 0x0061 }
        goto L_0x000a;
    L_0x0061:
    ...
    L_0x0064:
        ...
        goto L_0x0057;
        */
        throw new UnsupportedOperationException("Method not decompiled: dzs.a(boolean):void");
    }
