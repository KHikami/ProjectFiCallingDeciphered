...
public final class fxz {
    ...
    public static final fyc b = new fyc();
    private static final Class[] c = new Class[]{Integer.TYPE, String.class};
    ...
    public static aid a(Context context, fzo fzo, aid aid, String str) {
        ...
        if (a != null && a.length > 0) {
            return fxz.a(context, fzo, str, 1, a);
        }
    ...
    public static aid a(Context context, fzo fzo, String str) {
        if (str != null) {
            return fxz.a(context, fzo, str, 2, null);
        }
    ...
    private static aid a(Context context, fzo fzo, String str, int i, byte[] bArr) {
        ...
        if (fzo.b()) {
            ...
            for (fzp fzp : fzo.a()) {
                ...
                int b = fxz.b(connectivityManager);
                glk.c("Babel_SMS", "ensureRouteToHost: addressTypes=" + b, new Object[0]);
                Throwable th2 = th;
                for (InetAddress inetAddress : fxz.a(r3, b)) {
                    ...
                    try {
                        if (fxz.a(connectivityManager, inetAddress)) {
