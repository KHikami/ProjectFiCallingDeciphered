...
public final class iko {
    ...
    private static final iud b = new iud(new iuc(160, 100), 15);
    private static final iud c = new iud(new iuc(320, HttpStatusCodes.STATUS_CODE_OK), 15);
    private static final iud d = new iud(new iuc(480, HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES), 15);
    private static final iud e = new iud(new iuc(640, 400), 30);
    private static final iud f = new iud(new iuc(960, 600), 30);
    private static final iud g = new iud(new iuc(1280, 800), 30);
    private Context h;
    private boolean i;
