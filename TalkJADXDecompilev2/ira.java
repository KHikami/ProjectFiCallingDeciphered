...
public final class ira implements irc {
    private static final int d = (gwb.at() ? 12344 : 12610);
    private static final int[] e = new int[]{12344};
    private static final int[] f = new int[]{12324, 8, 12323, 8, 12322, 8, 12352, 4, d, 1, 12344};
    EGLDisplay a;
    EGLContext b;
    EGLConfig c;
