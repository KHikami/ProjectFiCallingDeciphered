...
public class lfy {
    private static final ThreadPolicy a = new Builder().detectAll().penaltyDeath().penaltyLog().build();
    private static final ThreadPolicy b = new Builder().detectNetwork().penaltyDeath().penaltyLog().build();
