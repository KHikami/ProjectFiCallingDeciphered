...
public final class cxv implements cxm {
    static final int a = ba.kw;
    static final int b = ba.kx;
    static final int c = ba.kA;
    static final int d = ba.ky;
    static final int e = ba.kz;
    OnClickListener A;
    volatile boolean B = false;
    private final cyc C = new cyc(this);
    private int D;
    ...
    MenuItem x;
    MenuItem y;
    List<OnClickListener> z = new ArrayList();
