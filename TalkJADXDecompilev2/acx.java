...
public class acx extends aef {
    ...
    int a(aek aek, ada ada, aep aep, boolean z) {
        int i = ada.c;
        if (ada.g != nzf.UNSET_ENUM_VALUE) {
            if (ada.c < 0) {
                ada.g += ada.c;
            }
            a(aek, ada);
    ...
    int d(int i) {
        switch (i) {
            ...
            case 2:
                ...
                return 1;
            case wi.dK /*17*/:
                return this.i != 0 ? nzf.UNSET_ENUM_VALUE : -1;
            case 33:
                return this.i != 1 ? nzf.UNSET_ENUM_VALUE : -1;
            case 66:
