...
public final class jfq {
    ...
    private final lo<String, Property<?, ?>[]> c = new lo();
    private final lo<String, String[]> d = new lo();
                        ...
                        if (this.d.containsKey(str)) {
                            ...
                            if (strArr == null) {
                                if (jfr.a(propertyArr[0])) {
                                    propertyArr[0].set(obj, Float.valueOf(jfq.a(jfr, propertyArr[0], jSONObject2.getDouble(str))));
                                }
                            }
                            ...
                            while (i2 < length2) {
                                if (jfr.a(propertyArr[i2]) && jSONObject3.has(strArr[i2])) {
                                    propertyArr[i2].set(obj, Float.valueOf(jfq.a(jfr, propertyArr[i2], jSONObject3.getDouble(strArr[i2]))));
                                }
                                i2++;
                            }
                        }
                ...
                if (length2 > 0) {
                    ...
                    while (i2 < propertyArr.length) {
                        ...
                        while (i3 < length2) {
                            ...
                            keyframeArr2[i3] = Keyframe.ofFloat(f, jfq.a(jfr, property, d));
