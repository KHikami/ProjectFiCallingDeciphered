...
public class fde implements jcd, jnh {
    ...
    public static final ConcurrentHashMap<Integer, fdh> b = new ConcurrentHashMap();
    static Boolean c = null;
    public static fdj d = new fdj();
    static fdg e = new fdg();
    private static final String[] f = new String[]{"Init", "Pending", "Ready", "Err_net", "Err_gcm", "Err_svr", "Err_auth", "Err_profile", "Err_oobe", "Err_transient"};
    private static fdi h = new fdi();
    private static final Comparator<jch> i = new fdf();
