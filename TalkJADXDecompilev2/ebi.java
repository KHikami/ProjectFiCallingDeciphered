...
interface ebi {
    public static final String[] a = new String[]{"author_first_name", "type", "conversation_id", "conversation_name", "generated_name", "conversation_type", "timestamp", "participant_keys", "call_media_type"};
