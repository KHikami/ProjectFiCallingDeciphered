...
public abstract class gno extends gmt implements bnq {
    ...
    protected void a(List<String> list, int i, bko bko, List<String> list2) {
        ...
        if (n) {
            ...
            int i2 = this.l;
            String str3 = this.f;
            String defpackage_bnn = a3 == null ? "null" : a3.toString();
            ...
            new StringBuilder((((String.valueOf(str3).length() + 119) + String.valueOf(defpackage_bnn).length()) + String.valueOf(h).length()) + String.valueOf(str2).length()).append("CLIV(").append(i2).append(") setAvatarUrls convId=").append(str3).append(" newRequest=").append(defpackage_bnn).append(" oldBitmap=").append(h).append(" clearPrev=").append(z3).append(" fetch=").append(z4).append(" setDefault=").append(z2).append(" avatarUrls=").append(str2);
        }
        if (z3) {
            B();
        }
        ...
        if (z4) {
            ...
            if (n) {
                int i3 = this.l;
                defpackage_bnn = c == null ? "true" : "false";
                String num = list == null ? "null" : Integer.toString(list.size());
                new StringBuilder((String.valueOf(defpackage_bnn).length() + 79) + String.valueOf(num).length()).append("CLIV(").append(i3).append(") setAvatarUrls setting default avatar: oldkeynull=").append(defpackage_bnn).append(" avatarUrls=").append(num);
            }
        }
    }
