...
public final class dxg {
    static final String[] a = new String[]{"lookup", "contact_id", "display_name", "raw_contact_id", "account_name", "photo_uri", "mimetype", "data1", "data2", "data3", "data4"};
    static final mjx<String, Integer> b = new mjz().a("data1", Integer.valueOf(7)).a("data2", Integer.valueOf(8)).a("data3", Integer.valueOf(9)).a("data4", Integer.valueOf(10)).a();
    static final String[] c = new String[]{"name", "gaia_id", "profile_photo_url", "sequence", "logging_id", "affinity_score"};
    ...
    private mmc<String, dxj> k = new mme(8).c().a();
