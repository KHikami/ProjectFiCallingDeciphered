...
final class jam {
    private static final Logger a = Logger.getLogger(jam.class.getName());
    private static final Map<Integer, jbg> b = Collections.synchronizedMap(new HashMap());
    private static final Map<String, jbg> c = Collections.synchronizedMap(new HashMap());
    private static final Set<Integer> d = gwb.aA();
    private static final Set<String> e = gwb.aC();
    ...
    static jbh a(InputStream inputStream, int i) {
        ...
        try {
            ...
            try {
                jbh jbh = new jbh();
                jbh.b(jam.a(objectInputStream, 16384));
                try {
    ...
    static jbg a(String str) {
        ...
        synchronized (c) {
            if (!c.containsKey(str)) {
                ...
                for (Object put : jam.a(resourceAsStream, 16384).a) {
                    c.put(str, put);
                }
            }
        }
