...
public final class jph extends jkj implements jts, jtt {
    private static final jpk A = w.a(v);
    private static final jpk[] B = new jpk[]{p, o.a(p), y, s.a(p), t.a(q), r.a(q), u.a(q), v.a(q)};
    private static final jpk[] C = new jpk[]{o, s, z, v.a(t), q, w.a(t), r.a(t), u.a(t)};
    private static final jpk[] D = new jpk[]{o, v, A, t, r.a(w), u.a(w), x.a(w)};
    ...
    static int d;
    static int e;
    private static final jpk o = new jpk(3, 0);
    private static final jpk p = new jpk(6, 3);
    private static final jpk q = new jpk(6, 2);
    private static final jpk r = new jpk(6, 1);
    private static final jpk s = new jpk(7, 3);
    private static final jpk t = new jpk(7, 2);
    private static final jpk u = new jpk(7, 1);
    private static final jpk v = new jpk(8, 3);
    private static final jpk w = new jpk(8, 2);
    private static final jpk x = new jpk(8, 1);
    private static final jpk y = q.a(p);
    private static final jpk z = t.a(s);
    private String L;
    private File M;
    private File N;
    private jpk O;
