...
public final class awn {
    public static final anw<anr> a = anw.a("com.bumptech.glide.load.resource.bitmap.Downsampler.DecodeFormat", anr.c);
    public static final anw<awf> b = anw.a("com.bumptech.glide.load.resource.bitmap.Downsampler.DownsampleStrategy", awf.c);
    private static final Set<String> c = Collections.unmodifiableSet(new HashSet(Arrays.asList(new String[]{"image/vnd.wap.wbmp", "image/x-ico"})));
    private static final awp d = new awo();
    private static final Set<ImageType> e = Collections.unmodifiableSet(EnumSet.of(ImageType.JPEG, ImageType.PNG_A, ImageType.PNG));
    private static final Queue<Options> f = baq.a(0);
    private final ard g;
    ...
    public aqr<Bitmap> a(InputStream inputStream, int i, int i2, anz anz, awp awp) {
        ...
        try {
            ...
            if ((c.inSampleSize == 1 || 19 <= VERSION.SDK_INT) && b(inputStream)) {
                float f2 = awn.a(c) ? ((float) c.inTargetDensity) / ((float) c.inDensity) : 1.0f;
                a2 = c.inSampleSize;
            ...
            Bitmap a5 = awn.a(inputStream, c, awp);
            awp.a(this.g, a5);
            if (Log.isLoggable("Downsampler", 2)) {
                String valueOf2 = String.valueOf(awn.a(a5));
                String valueOf3 = String.valueOf(awn.b(c));
                i4 = c.inSampleSize;
                i3 = c.inDensity;
    ...
    private static Bitmap a(InputStream inputStream, Options options, awp awp) {
        ...
        try {
            ...
            String valueOf = String.valueOf(awn.b(options));
    ...
    private static String b(Options options) {
        return VERSION.SDK_INT >= 11 ? awn.a(options.inBitmap) : null;
    }
