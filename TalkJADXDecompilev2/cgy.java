...
public final class cgy {
    ...
    private final Collection<bpd> m = new HashSet();
    private final boolean n;
    private final Comparator<bpd> o = new chc(this);
    ...
    private Collection<bpd> a(String str, Collection<cgc> collection, bjm bjm) {
        try {
            ...
            for (cgc cgc : collection) {
                ...
                edk a3 = cgy.a(a, a2, ((fzw) jyn.a(this.h, fzw.class)).a(this.i));
                if (this.e != null) {
            ...
            if (!hashSet.isEmpty()) {
                ...
                if (TextUtils.equals(str, a)) {
                    for (Integer num : hashSet) {
                        ...
                        chd chd2 = chd;
                        chd2.a(new bpd(null, gwb.a(num), gwb.a(this.h, str2, null, null), str2, null, str2, chg.b.a(), null, chg.a, TextUtils.isEmpty(str2)));
                        if (this.e != null) {
