...
public class bjs extends SQLiteOpenHelper {
    public static final String[] a = new String[]{"type", "mmsc", "mmsproxy", "mmsport", "_id", "current", "numeric", "name", "mcc", "mnc", "apn"};
    public static final String[] b = new String[]{"name", "mcc", "mnc", "apn", "user", "server", "password", "proxy", "port", "mmsc", "mmsproxy", "mmsport", "authtype", "type", "protocol", "roaming_protocol", "carrier_enabled", "bearer", "mvno_type", "mvno_match_data", "current"};
    public static final String[] c = new String[]{"key", "value", "type"};
    ...
    public static void a(SQLiteDatabase sQLiteDatabase, List<ContentValues> list) {
        ...
        if (list != null && list.size() > 0) {
            for (ContentValues contentValues : list) {
                ...
                try {
                    query = sQLiteDatabase.query("apn", f, stringBuilder.toString(), (String[]) arrayList.toArray(new String[arrayList.size()]), null, null, null);
                    if (query != null) {
                        try {
                            ...
                            try {
                                ...
                                glk.d("Babel_ApnDb", new StringBuilder(String.valueOf(valueOf).length() + 50).append("ApnDatabase.saveUserDataFromOldTable: query error ").append(valueOf).toString(), e);
                                if (query != null) {
                                    query.close();
                                }
                            } catch (Throwable th) {
