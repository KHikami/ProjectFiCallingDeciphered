...
public final class iuq {
    ...
    private double b = 18.0d;
    private final CopyOnWriteArrayList<iur> c = new CopyOnWriteArrayList();
    private double d;
    private double e;
    private double f;
    private double g;
    ...
    public boolean c(double d) {
        ...
        while (this.o >= 0.001d) {
            ...
            d7 = d3 + (d5 * 0.001d);
            if (this.n && iuq.a(d6, this.a, this.i, this.j)) {
                this.o = 0.0d;
                d5 = d2;
                d4 = d9;
                d2 = d6;
        ...
        Object obj = (this.n && iuq.a(this.f, this.a, this.i, this.j)) ? 1 : null;
        if (obj != null || a()) {
            if (this.a > 0.0d) {
                this.i = this.j;
                this.f = this.j;
