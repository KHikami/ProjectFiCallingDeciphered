...
final class aew extends Drawable {
    ...
    private void a(float f, float f2) {
        if (f < 0.0f) {
            ...
            float a = (float) aew.a(f);
            float a2 = (float) aew.a(f2);
            if (a > a2) {
                if (!this.s) {
                    this.s = true;
                }
    ...
    public boolean getPadding(Rect rect) {
        int ceil = (int) Math.ceil((double) aew.a(this.k, this.h, this.r));
        int ceil2 = (int) Math.ceil((double) aew.b(this.k, this.h, this.r));
