...
public final class jib {
    private static final String[] a = new String[]{"name"};
    private static final ThreadLocal<ContentValues> b = new jic();
    private static final String[] c = new String[0];
    private static final ThreadLocal<String[]> d = new jid();
    private static final ThreadLocal<String[]> e = new jie();
    private static final ThreadLocal<String[]> f = new jif();
