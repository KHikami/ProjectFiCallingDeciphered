...
public final class did extends fip implements gia<fln> {
    ...
    private itf N;
    private gic O;
    private final Runnable P = new die(this);
    private final Runnable Q = new dif(this);
    private final Runnable R = new dig(this);
    private final Runnable S = new dih(this);
    public final dgg a = dgg.a();
    boolean b;
    ...
    private boolean q;
    private boolean r;
    private final ArrayList<djs> s = new ArrayList();
