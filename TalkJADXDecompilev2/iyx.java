...
final class iyx {
    ...
    private final izb c = new izb();
    private final izb d = new izb();
    private final izd<iyu> e = new izd();
    private final izd<iyw> f = new izd();
    private final Map<String, List<iyw>> g = new ky();
    private final izb h = new izb();
    private final izd<iyy> i = new izd();
    private final izf<iyy> j = new izf();
