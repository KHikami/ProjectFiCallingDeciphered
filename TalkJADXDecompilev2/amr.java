...
public final class amr {
    private final auk a = new auk(this.i);
    private final ayz b = new ayz();
    private final azd c = new azd();
    private final azf d = new azf();
    private final aoi e = new aoi();
    private final ayd f = new ayd();
    private final azc g = new azc();
    private final azb h = new azb();
    private final ll<List<Exception>> i = bas.a();
