...
public final class ebs extends ecj {
    static ebw o = new ebw();
    private static final boolean t = ebz.d;
    public fwy a;
    ...
    public ebs(Cursor cursor, int i) {
        ...
        int a2 = ebs.a(cursor.getString(13));
                        ...
                        for (int i5 = 0; i5 < list2.size(); i5++) {
                            if (list2.get(i5) instanceof ebs) {
                                ...
                                if (!TextUtils.isEmpty(ebs.k)) {
                                    ...
                                    if (blr != null) {
                                        ebs.a(i, ((ear) list.get(i4)).a, Long.parseLong(ebs.l), blr, b);
                                    }
                                    ba.a(i, glj.b(), 10, b);
                                }
                            }
    ...
    static /* synthetic */ eap a(Context context, int i, boolean z, int i2) {
        ...
        if (fdq.w.b(i)) {
            ebs.a(contentResolver, a, valueOf, strArr, arrayList, i);
            ebs.a(contentResolver, a, str, strArr, arrayList, i);
        } else {
            ebs.a(contentResolver, a, replace, strArr, arrayList, i);
        }
        blr blr = new blr();
        if (fdq.w.b(i)) {
            ebs.a(i, arrayList, 407, 0, z, blr);
        } else {
            ebs.a(i, arrayList, (int) HttpStatusCodes.STATUS_CODE_NOT_FOUND, 462, z, blr);
        }
