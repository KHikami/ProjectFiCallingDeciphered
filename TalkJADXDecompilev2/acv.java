...
public class acv extends ViewGroup {
    ...
    void b(int i, int i2) {
        ...
        while (i11 < m) {
            ...
            if (c == null) {
                ...
                if (c.getVisibility() != 8) {
                    ...
                    i5 = acw2.topMargin + acw2.bottomMargin;
                    measuredHeight = c.getMeasuredHeight() + i5;
                    a = age.a(i7, oa.f(c));
                    if (z) {
        ...
        if (z2 && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            while (i15 < m) {
                ...
                if (c2 == null) {
                    ...
                    acw = (acw) c2.getLayoutParams();
                    if (obj != null) {
                        this.f = (acw.rightMargin + (acw.leftMargin + i10)) + this.f;
                        i3 = i15;
                    } else {
                        measuredHeight = this.f;
                        this.f = Math.max(measuredHeight, acw.rightMargin + ((measuredHeight + i10) + acw.leftMargin));
                        i3 = i15;
                    }
                }
                i15 = i3 + 1;
        ...
        i6 = oa.a(Math.max(this.f, getSuggestedMinimumWidth()), i, 0);
            ...
            while (i9 < m) {
                ...
                if (c3 == null || c3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        childMeasureSpec = age.a(i4, oa.f(c3) & -16777216);
                        f5 = f6;
                        i12 = measuredHeight;
                    } else {
                        i12 = measuredHeight;
        ...
        setMeasuredDimension((-16777216 & i7) | i6, oa.a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i7 << 16));
        if (obj3 != null) {
