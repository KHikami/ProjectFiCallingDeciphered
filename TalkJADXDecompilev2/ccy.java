...
public final class ccy {
    ...
    public static boolean a(Uri uri) {
        if (uri.getLastPathSegment().equals(ccy.a(1)) || uri.getLastPathSegment().equals(ccy.a(2))) {
            return true;
        }
        return false;
    }
    ...
    public static String b(Uri uri) {
        ...
        String a2 = ccy.a("yyyyMMdd_HHmmss");
        String str = ".jpg";
    ...
    public static File a(bxo bxo) {
        String str;
        String a = ccy.a("yyyyMMdd_HHmmss");
        ...
        return new File(ccy.a(), new StringBuilder(((String.valueOf(str2).length() + 0) + String.valueOf(a).length()) + String.valueOf(str).length()).append(str2).append(a).append(str).toString());
    }
    ...
    public static bxy a(Context context, int i, bxo bxo, File file, String str, String str2) {
        ...
        return ccy.a(context, i, bxo, Uri.fromFile(file2), file2.getName(), str2);
    }
    ...
    public static bxy a(Context context, int i, bxo bxo, Uri uri, String str, String str2) {
        ...
        if (bxy.c == bxo.VIDEO) {
            ccy.a(uri, contentResolver, context, bxy);
        } else if (bxy.c == bxo.PHOTO) {
            ccy.a(uri, contentResolver, bxy);
        }
        return bxy;
    }
    ...
    public static void a(Uri uri, ContentResolver contentResolver, bxy bxy) {
        ...
        bxy.h = ccy.a(uri, contentResolver);
