...
public final class bjw extends bnn implements bnq {
    ...
    private static final double w = ((1.0d - Math.sin(Math.acos(ExponentialBackOffPolicy.DEFAULT_RANDOMIZATION_FACTOR))) / 4.0d);
    private Bitmap j;
    private Canvas k;
    ...
    private final bnn[] r = new bnn[4];
    private final fwu s = new fwu();
    private Rect t;
    private Rect u;
    ...
    private void a(Bitmap bitmap, int i) {
        ...
        int b2 = ((bjx) this.f).b();
        int i2 = b2 / 2;
        bjw.a(this.t, b.getWidth(), b.getHeight());
        int i3;
        switch (this.n) {
            case 1:
                switch (i) {
    ...
    public void a(defpackage.gkt r8, defpackage.gjo r9, boolean r10, defpackage.bnn r11, boolean r12) {
        /*
        r7 = this;
        r1 = 0;
        r0 = "Expected null";
        defpackage.iil.a(r0, r9);
        defpackage.iil.b();
        r0 = i;
    ...
    L_0x005e:
        r0 = defpackage.gwb.H();
        r2 = defpackage.boz.class;
        r0 = defpackage.jyn.a(r0, r2);
        r0 = (defpackage.boz) r0;
        r0 = r0.b();
    L_0x006e:
        r2 = r7.r;
        monitor-enter(r2);
    ...
    L_0x0097:
        ...
        defpackage.glk.e(r0, r1, r3);	 Catch:{ all -> 0x00a3 }
        monitor-exit(r2);	 Catch:{ all -> 0x00a3 }
        goto L_0x007b;
    L_0x00a3:
        r0 = move-exception;
