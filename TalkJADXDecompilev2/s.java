...
public final class s extends LinearLayout {
    ...
    protected /* synthetic */ LinearLayout.LayoutParams m15generateDefaultLayoutParams() {
        return s.d();
    }
    ...
    protected /* synthetic */ LayoutParams generateLayoutParams(LayoutParams layoutParams) {
        return s.a(layoutParams);
    }

    public /* synthetic */ LinearLayout.LayoutParams m16generateLayoutParams(AttributeSet attributeSet) {
        return a(attributeSet);
    }

    protected /* synthetic */ LinearLayout.LayoutParams m17generateLayoutParams(LayoutParams layoutParams) {
        return s.a(layoutParams);
    }
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[1] = i2;
        return s.mergeDrawableStates(onCreateDrawableState, iArr);
    }
