...
public final class oag extends nyx<oag> {
    public static final nyy<nzr, oag> a = nyy.a(11, oag.class, 222624570);
    private static final oag[] z = new oag[0];
    public khd b;
    public String c;
    public String d;
    public oap[] e;
