...
public class fkr implements bhf, bhj, bhm {
    ...
    public int a(Context context, bhb bhb) {
        try {
            ((bhl) jyn.a(context, bhl.class)).a(new feg(new evb(gwb.a(context, "babel_sc_max_pinned", 500), gwb.a(context, "babel_sc_max_favorites", 15), gwb.a(context, "babel_sc_max_you_hangout_with", 500), gwb.a(context, "babel_sc_max_other_contacts_on_hangouts", 500), gwb.a(context, "babel_sc_max_dismissed", 500), bkq.c(context, this.a, "hash_pinned"), bkq.c(context, this.a, "hash_favorites"), bkq.c(context, this.a, "hash_people_you_hangout_with"), bkq.c(context, this.a, "hash_other_people_on_hangout"), bkq.c(context, this.a, "hash_dismissed_contacts")), this.a));
