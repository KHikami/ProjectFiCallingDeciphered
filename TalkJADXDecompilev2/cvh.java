...
public final class cvh {
    final cus a;
    final List<cvm> b = new CopyOnWriteArrayList();
    final Map<String, List<cvn>> c = new HashMap();
    private final ite d;
    private final ijf e;
    private final ijd f;
    private final lym g;
    private boolean h;
    private final itg i = new cvi(this);
    private final ijj<lym> j = new cvj(this);
    private final ijj<mab> k = new cvk(this);
    private final cuz l = new cvl(this);
