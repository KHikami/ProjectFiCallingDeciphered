...
public final class hfe extends gui implements hfy {
    final Queue<heb<?, ?>> b = new LinkedList();
    hfs c;
    final Map<gue<?>, gug> d;
    ...
    private final hfg t;
    private final gtp u;
    private final hgh v = new hgh();
    private final ArrayList<hek> w;
    private Integer x = null;
    private final gwi y = new hff(this);
    ...
    private void b(int i) {
        if (this.x == null) {
            ...
            String valueOf = String.valueOf(hfe.c(i));
            String valueOf2 = String.valueOf(hfe.c(this.x.intValue()));
    ...
    public ConnectionResult a(long j, TimeUnit timeUnit) {
        ...
        try {
            if (this.x == null) {
                this.x = Integer.valueOf(hfe.a(this.d.values(), false));
