        ...
        if (i >= 0 || (i2 & 1) != 0) {
            ...
            if (this.n > 0) {
                for (size = 0; size <= size2; size++) {
                    ((dg) arrayList.get(size)).a(sparseArray, sparseArray2);
                }
            }
            dk dkVar = null;
            int i4 = 0;
            while (i4 <= size2) {
                ...
                i4++;
                dkVar = dgVar.a(z, dkVar, sparseArray, sparseArray2);
            }
        } else {
            i3 = this.i.size() - 1;
            if (i3 < 0) {
            ...
            dgVar = (dg) this.i.remove(i3);
            SparseArray sparseArray3 = new SparseArray();
            SparseArray sparseArray4 = new SparseArray();
            if (this.n > 0) {
                dgVar.a(sparseArray3, sparseArray4);
            }
            dgVar.a(true, null, sparseArray3, sparseArray4);
        }
        w();
        return true;
    }
