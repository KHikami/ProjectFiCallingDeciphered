...
public final class hay implements HttpClient {
    private static final String[] d = new String[]{"text/", "application/xml", "application/json"};
    public hbc a;
    public HttpParams b;
    private hbb c;
    private Context e;
    ...
    private HttpResponse a(HttpURLConnection httpURLConnection) {
        ...
        this.a.a(httpURLConnection.getURL().toString(), responseCode);
        HttpResponse hba = new hba();
        hba.a = httpURLConnection;
    ...
    public HttpResponse execute(HttpUriRequest httpUriRequest, HttpContext httpContext) {
        ...
        if (Looper.myLooper() == null || Looper.myLooper() != Looper.getMainLooper()) {
            ...
            HttpURLConnection a = hbc.a(toURL, network);
            a.setInstanceFollowRedirects(false);
            hbb hbb = this.c;
            if (hbb != null && hbb.a()) {
                hbb.a(hay.a(httpUriRequest, a, hbb.a));
            }
            a(a, httpUriRequest);
            return a(a);
        }
