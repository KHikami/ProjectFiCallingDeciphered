...
final class jrv {
    static final long a = kdk.d.a(10);
    private static final Bundle c;
    private static final Set<String> d;
    private static final Pattern e = Pattern.compile("bytes=(\\d+)-(\\d+)");
    private static final jpz t = new jpx();
    final jre b;
    private jro f;
    private String g;
    private boolean h;
    private final Context i;
    private final jvk j = new jvk(this.i, this.k, "oauth2:https://www.googleapis.com/auth/plus.me https://www.googleapis.com/auth/plus.stream.read https://www.googleapis.com/auth/plus.stream.write https://www.googleapis.com/auth/plus.circles.write https://www.googleapis.com/auth/plus.circles.read https://www.googleapis.com/auth/plus.photos.readwrite https://www.googleapis.com/auth/plus.native");
    ...
    private final jrk o;
    private final jpu p;
    private final jqx q = ((jqx) jyn.b(this.i, jqx.class));
    private final jrj r = ((jrj) jyn.b(this.i, jrj.class));
    private final jpz s = new jpw(this.i);
