...
class ipe implements ipb<byte[]> {
    ...
    public byte[] a() {
        ...
        try {
            try {
                bArr = ipe.a(new ipc(this.i.createRequestFactory(new ipf(str2, str, keg, i)).buildPostRequest(new GenericUrl(new URL(new URL(this.e), this.b)), new ipa(this.c)).execute()));
            } catch (Throwable e) {
