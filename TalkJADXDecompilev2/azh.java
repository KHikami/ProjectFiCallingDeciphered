...
public class azh<CHILD extends azh<CHILD>> implements Cloneable {
    ...
    Drawable n;
    int o;
    public anz p = new anz();
    Map<Class<?>, aoc<?>> q = new HashMap();
    ...
    public final CHILD a(azh<?> azh_) {
        ...
        if (azh.b(azh_.v, 1024)) {
            this.k = azh_.k;
        }
        if (azh.b(azh_.v, 4096)) {
            this.r = azh_.r;
        }
        if (azh.b(azh_.v, 8192)) {
            this.n = azh_.n;
        }
        if (azh.b(azh_.v, 16384)) {
            this.o = azh_.o;
        }
        if (azh.b(azh_.v, 32768)) {
            this.t = azh_.t;
        }
        if (azh.b(azh_.v, 65536)) {
            this.m = azh_.m;
        }
        if (azh.b(azh_.v, 131072)) {
            this.l = azh_.l;
        }
        if (azh.b(azh_.v, 2048)) {
