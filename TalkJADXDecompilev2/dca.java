...
public final class dca extends np {
    ...
    private static final Integer[] f = new Integer[]{Integer.valueOf(gwb.dl), Integer.valueOf(gwb.dn), Integer.valueOf(gwb.dm), Integer.valueOf(gwb.do), Integer.valueOf(gwb.dp)};
    final dcd a;
    final dbx b;
    final gjs c;
    int d = 0;
