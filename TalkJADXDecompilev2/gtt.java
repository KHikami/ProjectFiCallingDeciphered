...
public final class gtt extends gtv {
    @Deprecated
    public static final int a = gtv.b;
    ...
    public static void a(int i, Context context) {
        ...
        if (!gtv.b(context, i)) {
            if (!(i == 9 ? gtv.a(context, "com.android.vending") : false)) {
                gtt.a(i, context, null, gtp.a.a(context, i, 0, "n"));
                return;
            }
        }
    ...
    static void a(int i, Context context, PendingIntent pendingIntent) {
        gtt.a(i, context, null, pendingIntent);
    }
    ...
    public static boolean b(int i, Activity activity, int i2) {
        return gtt.a(i, activity, 0, null);
    }

    @Deprecated
    public static Dialog a(int i, Activity activity, int i2) {
        return gtt.a(i, activity, gwc.a(activity, gtp.a.a((Context) activity, i, "d"), i2), null);
    }

    @Deprecated
    public static boolean a(int i, Activity activity, int i2, OnCancelListener onCancelListener) {
        Dialog a = gtt.a(i, activity, gwc.a(activity, gtp.a.a((Context) activity, i, "d"), i2), onCancelListener);
        if (a == null) {
            return false;
        }
