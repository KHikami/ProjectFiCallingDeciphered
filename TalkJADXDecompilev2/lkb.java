...
public final class lkb {
    static final kae a = new kae("tiktok_systrace", (byte) 0);
    static final AtomicLong b = new AtomicLong(1);
    public static final ThreadLocal<ljo> c = new ThreadLocal();
    static ljo d;
    static final List<ljo> e = new ArrayList();
    static final Runnable f = new lkc();
    public static ljo g;
    public static int h;
    public static int i = 0;
    private static final Runnable j = new lkd();

    public static lji a(String str) {
        return lkb.a(str, lhc.I_AM_THE_FRAMEWORK);
    }
    ...
    static String c(ljo ljo) {
        ...
        String valueOf = String.valueOf(lkb.c(ljo.a()));
