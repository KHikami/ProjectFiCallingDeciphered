...
public final class blo {
    private static final String[] A = new String[]{"conversation_id", "call_media_type"};
    ...
    private static final String[] C = new String[]{"timestamp"};
    private static final String[] D = new String[]{"conversation_type"};
    private static final String[] E = new String[]{"conversation_id"};
    private static final String[] F = new String[]{"conversation_id"};
    static final String[] b = new String[]{"notification_level", "view"};
    private static final boolean c = false;
    private static final gma d = gma.a("EsConversationsHelper");
    private static final String[] i = new String[]{"gaia_id", "chat_id", "name", "first_name", "profile_photo_url", "packed_circle_ids"};
    private static final String[] j = new String[]{"_id", "gaia_id", "chat_id", "phone_id", "circle_id", "full_name", "first_name", "fallback_name", "profile_photo_url", "batch_gebi_tag", "blocked", "participant_type"};
    private static final Random k = mfo.a;
    private static final String[] l = new String[]{"photo_id", "url", "file_name", "last_used"};
    private static final String[] m = new String[]{"album_id", "cover_photo_id", "title", "last_used"};
    private static String o;
    private static String p;
    private static String q;
    private static final String[] r = new String[]{"conversation_id"};
    private static final String[] s = new String[]{"latest_message_timestamp", "latest_message_expiration_timestamp", "snippet_type", "snippet_text", "snippet_author_chat_id", "snippet_image_url", "chat_watermark", "hangout_watermark"};
    private static final String[] t = new String[]{"gaia_id", "chat_id", "circle_id", "phone_id"};
    ...
    private static final String[] v = new String[]{"local_url"};
    private static final String[] w = new String[]{"conversation_id", "self_watermark"};
    private static final String x = String.format(Locale.US, "%s=? AND %s=?", new Object[]{"conversation_id", "participant_type"});
    private static final String[] y = new String[]{"first_peak_scroll_time", "first_peak_scroll_to_message_timestamp", "second_peak_scroll_time", "second_peak_scroll_to_message_timestamp"};
    private static final String[] z = new String[]{"sort_timestamp"};
    final Context a;
    private final bmv e;
    private final bko f;
    private final int g;
...
*/
    ...
    public java.lang.String a(java.util.List<defpackage.edk> r6, int r7) {
        /* JADX: method processing error */
/*
...
*/
    ...
    public java.lang.String b(java.util.List<defpackage.edk> r6) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0029 in list [B:11:0x0026]
	at jadx.core.utils.BlockUtils.getBlockByOffset(BlockUtils.java:43)
...
*/
    ...
    public boolean c(String str, long j) {
        ...
        int a2 = a("conversation_id=? AND (timestamp<=? OR timestamp IS NULL)", new String[]{str, String.valueOf(j)});
        try {
            a = this.e.a("messages", new String[]{"_id"}, "conversation_id=?", new String[]{str}, null, null, null);
            try {
    ...
    public void a(HashSet<edo> hashSet) {
        Cursor a;
        Throwable th;
        ...
        while (it.hasNext()) {
            ...
            if (!TextUtils.isEmpty(edo.a)) {
                str = "gaia_id=?";
                strArr = new String[]{edo.a};
            } else if (TextUtils.isEmpty(edo.b)) {
                continue;
            } else {
                str = "chat_id=?";
                strArr = new String[]{edo.b};
            }
            try {
                a = this.e.a("conversation_participants_view", r, str, strArr, null, null, null);
                try {
                    if (a.moveToFirst()) {
                        do {
    ...
    private static int a(blo blo, String str, bjm bjm) {
        ...
        if (TextUtils.isEmpty(str)) {
            Cursor cursor = bmk.a;
            a = e.a("participants", (String[]) cursor, bmk.b, null, null, null, null);
        } else {
            String[] strArr = bmk.a;
            a = e.a("conversation_participants_view", strArr, bmk.c, new String[]{str}, null, null, null);
        }
        if (a == null) {
            return 0;
        }
        ...
        try {
            ...
            while (a.moveToNext()) {
                ...
                bmi a2 = blo.a(bjm, string, string2, string3);
                if (!TextUtils.equals(a2.a, string2) || !TextUtils.equals(a2.b, string3)) {
                    ...
                    int a3 = e.a("participants", contentValues, "_id=?", strArr2) + i2;
                    if (strArr == null) {
                        hashSet = new HashSet();
                    } else {
                        Object obj = strArr;
            ...
            if (strArr != null) {
                ...
                cursor = e.a("SELECT DISTINCT conversations.conversation_id  FROM conversations JOIN conversation_participants  WHERE conversation_participants.conversation_id=conversations.conversation_id  AND conversation_participants.participant_row_id IN (?); ", new String[]{join});
                if (cursor != null) {
                    if (cursor.moveToFirst()) {
                        i2 += cursor.getCount();
                        while (true) {
                            blf.b(blo, cursor.getString(0));
...
*/
            ...
            public List<eyg> a(boolean z) {
                Cursor cursor = null;
                List<eyg> arrayList = new ArrayList();
                Throwable th;
                try {
                    Cursor a;
                    Cursor a2 = this.e.a("sticker_albums", m, null, null, null, null, null);
                    if (a2 != null) {
                        while (a2.moveToNext()) {
                            try {
                                eyg eyg = new eyg();
                                eyg.a = a2.getString(0);
                                eyg.b = a2.getString(2);
                                eyg.d = (long) a2.getInt(3);
                                if (z) {
                                    eyg.e = new ArrayList();
                                    try {
                                        a = this.e.a("sticker_photos", l, "album_id=?", new String[]{eyg.a}, null, null, null, null);
                                        while (a != null) {
                                            if (!a.moveToNext()) {
                                                break;
                                            }
                                            ...
                                            if (eyi.a.equals(a2.getString(1))) {
                                                eyg.c = eyi;
                                            } else {
                                                try {
                                                    if (eyg.c == null && a2.getString(1) == null) {
                                                        eyg.c = eyi;
                                                    }
                                                } catch (Throwable th2) {
                                                    th = th2;
