...
public final class iqy implements irc {
    ...
    private static final int[] f = new int[]{12324, 8, 12323, 8, 12322, 8, 12352, 4, e, 1, 12344};
    EGL10 a;
    EGLDisplay b;
    EGLContext c;
    EGLConfig d;
    ...
    private EGLConfig a(EGLConfig[] eGLConfigArr) {
        for (EGLConfig eGLConfig : eGLConfigArr) {
            int a = iqy.a(this.a, this.b, eGLConfig, 12324, 0);
            int a2 = iqy.a(this.a, this.b, eGLConfig, 12323, 0);
            int a3 = iqy.a(this.a, this.b, eGLConfig, 12322, 0);
            if (a == 8 && a2 == 8 && a3 == 8) {
                return eGLConfig;
            }
        }
