...
public class evz implements Serializable {
    ...
    private static final eze g = new eze();
    ...
    public void a(blo blo, fhc fhc) {
        this.f = true;
        evz.a((blo != null ? blo.g() : null).g(), this.c);
    }
    ...
    public static boolean a(kmu kmu) {
        return (kmu == null || kmu.a == null) ? false : true;
    }
    ...
    public static void a(int i, eze eze) {
        if (fdq.n.b(i) && eze != null) {
            if (eze.e == ezf.b) {
                ...
                RealTimeChatService.a(i, false, fjl.HASH_SYNC_DELAY, eze.f, flt.HASH_SYNC);
