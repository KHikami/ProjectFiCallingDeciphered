...
public final class kdh {
    ...
    public static Bitmap a(Bitmap bitmap, int i, int i2, Bitmap bitmap2) {
        ...
        kdh.a(canvas, bitmap, new Rect(width2, height2, width + width2, height + height2), new Rect(0, 0, i, i2));
        return createBitmap;
    }
    ...
    public static Bitmap a(Bitmap bitmap, int i, int i2) {
        ...
        if (bitmap.getWidth() == i && bitmap.getHeight() == i) {
            ...
            kdh.a(canvas, bitmap, new Rect(0, 0, bitmap.getWidth(), bitmap.getHeight()), new Rect(0, 0, i, i));
        }
        return createBitmap;
    }
}
