...
public class ain {
    ...
    protected aim a(ByteArrayInputStream byteArrayInputStream) {
        ...
        while (i != 0 && byteArrayInputStream.available() > 0) {
            ...
            int f = ain.f(byteArrayInputStream);
            if (f < 32 || f > 127) {
                byte[] b;
                int indexOf;
                byte[] a;
                ...
                switch (f) {
                    ...
                    case 159:
                        try {
                            aim.a(ain.h(byteArrayInputStream), f);
                            break;
                    ...
                    case 179:
                        try {
                            aim.a(ain.i(byteArrayInputStream), f);
                            break;
