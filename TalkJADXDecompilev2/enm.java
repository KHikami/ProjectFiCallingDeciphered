...
public final class enm {
    private static final enp a = enp.a("=").a();
    private static final enp b = enp.a("/").a();
    private static final eno c = new eno("/");
    ...
    public static Uri a(String str, String str2) {
        ...
        List a = enm.a(b.a(parse.getPath()));
        int size = a.size();
        ...
        if (i2 >= 4 && i2 <= 6) {
            ...
            valueOf = (String) enm.a(a.a(parse.getPath())).get(0);
